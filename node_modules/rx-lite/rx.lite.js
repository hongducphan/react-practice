...
(function(undefined) {
  ...
  var noop = (Rx.helpers.noop = function() {}),
    ...
    isPromise = (Rx.helpers.isPromise = function(p) {
      return (
        !!p && typeof p.subscribe !== "function" && typeof p.then === "function"
      );
    }),
  ...
  (function() {
    ...
    var setImmediate =
      typeof (setImmediate =
        freeGlobal && moduleExports && freeGlobal.setImmediate) == "function" &&
  ...
  var WithLatestFromObservable = (function(__super__) {
    ...
    WithLatestFromObservable.prototype.subscribeCore = function(o) {
      ...
      outerSad.setDisposable(
        this._s.subscribe(new WithLatestFromSourceObserver(o, this._cb, state))
      );
  ...
  var RetryWhenObservable = (function(__super__) {
    ...
    RetryWhenObservable.prototype.subscribeCore = function(o) {
      ...
      var state = { isDisposed: false },
        lastError,
        subscription = new SerialDisposable();
      var cancelable = currentThreadScheduler.scheduleRecursive(null, function(
        _,
        recurse
      ) {
        if (state.isDisposed) {
  ...
  observableProto.flatMapConcat = observableProto.concatMap = function(
    ...
    return new FlatMapObservable(this, selector, resultSelector, thisArg).merge(
      1
    );
  };
