...
(function(factory) {
  ...
  var IncludesObservable = (function(__super__) {
    ...
    IncludesObservable.prototype.subscribeCore = function(o) {
      ...
      return this.source.subscribe(
        new IncludesObserver(o, this._elem, this._n)
      );
    };
  ...
  var AverageObservable = (function(__super__) {
    ...
    AverageObservable.prototype.subscribeCore = function(o) {
      return this.source.subscribe(
        new AverageObserver(o, this._fn, this.source)
      );
    };
  ...
  observableProto.sequenceEqual = function(second, comparer) {
    ...
    return new AnonymousObservable(function(o) {
      ...
      (isArrayLike(second) || isIterable(second)) &&
        (second = observableFrom(second));
  ...
  var FirstObservable = (function(__super__) {
    ...
    FirstObservable.prototype.subscribeCore = function(o) {
      return this.source.subscribe(
        new FirstObserver(o, this._obj, this.source)
      );
    };
  ...
  function findValue(source, predicate, thisArg, yieldIndex) {
    ...
    return new AnonymousObservable(function(o) {
      return source.subscribe(
        new FindValueObserver(o, source, callback, yieldIndex)
      );
    }, source);
  }
  ...
  var LastIndexOfObservable = (function(__super__) {
    ...
    LastIndexOfObservable.prototype.subscribeCore = function(o) {
      ...
      return this.source.subscribe(
        new LastIndexOfObserver(o, this._e, this._n)
      );
    };
