  ...
  class Espree extends Parser {
    constructor(options, code) {
      ...
      this[STATE] = {
        ...
        comments:
          options.comment === true || options.attachComment === true
            ? []
            : null,
        attachComment: options.attachComment === true,
        impliedStrict:
          ecmaFeatures.impliedStrict === true && this.options.ecmaVersion >= 5,
    ...
    parse() {
      ...
      if (program.range) {
        program.range[0] = program.body.length
          ...
          : program.range[0];
        program.range[1] = extra.lastToken
          ? extra.lastToken.range[1]
          : program.range[1];
      }
      if (program.loc) {
        program.loc.start = program.body.length
          ...
          : program.loc.start;
        program.loc.end = extra.lastToken
          ? extra.lastToken.loc.end
          : program.loc.end;
      }
