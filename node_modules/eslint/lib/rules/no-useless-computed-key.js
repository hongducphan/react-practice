...
const MESSAGE_UNNECESSARY_COMPUTED =
      ...
      Property(node) {
        ...
        if (
          ...
          context.report({
            ...
            fix(fixer) {
              const leftSquareBracket = sourceCode.getFirstToken(
                node,
                astUtils.isOpeningBracketToken
              );
              const rightSquareBracket = sourceCode.getFirstTokenBetween(
                node.key,
                node.value,
              ...
              if (
                tokensBetween.slice(0, -1).some((token, index) =>
                  sourceCode
                    .getText()
              ...
              const tokenBeforeLeftBracket = sourceCode.getTokenBefore(
                leftSquareBracket
              );
