...
var findRouteName = function findRouteName(url) {
  var aroute = routes.find(function(route) {
    return (0,
    _reactRouterDom.matchPath)(url, { path: route.path, exact: route.exact });
  });
...
var Breadcrumbs = function Breadcrumbs(args) {
  ...
  return _react2.default.createElement(_reactstrap.Breadcrumb, null, items);
};
  ...
  AppBreadcrumb.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _extends({ path: "/:path", component: Breadcrumbs }, attributes)
      )
    );
  };
