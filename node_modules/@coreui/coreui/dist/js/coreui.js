...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("jquery"), require("perfect-scrollbar"))
    : typeof define === "function" && define.amd
    ? define(["exports", "jquery", "perfect-scrollbar"], factory)
  ...
  PerfectScrollbar =
    PerfectScrollbar && PerfectScrollbar.hasOwnProperty("default")
        ...
        _proto.loadPage = function loadPage(url) {
          ...
          $$$1.ajax({
            ...
            success: function success(result) {
              ...
              var scripts = Array.from(wrapper.querySelectorAll("script")).map(
                function(script) {
  ...
  var AsideMenu = (function($$$1) {
    ...
    var AsideMenu =
      ...
      (function() {
        ...
        // Private
        _proto._addEventListeners = function _addEventListeners() {
          $$$1(document).on(Event.CLICK, Selector.ASIDE_MENU_TOGGLER, function(
            event
          ) {
            event.preventDefault();
            event.stopPropagation();
            var toggle = event.currentTarget.dataset
              ? event.currentTarget.dataset.toggle
              : $$$1(event.currentTarget).data("toggle");
  ...
  var isIE1x = function isIE1x() {
    return (
      Boolean(document.documentMode) && document.documentMode >= minIEVersion
    );
  };
      ...
      (function() {
        ...
        _proto.perfectScrollbar = function perfectScrollbar(event) {
          ...
          if (typeof PerfectScrollbar !== "undefined") {
            ...
            if (
              event === Event.INIT &&
              !classList.contains(ClassName.SIDEBAR_MINIMIZED)
            ) {
          ...
          $$$1(Selector.NAVIGATION)
            ...
            .each(function(key, value) {
              ...
              if ($$$1($$$1(link))[0].href === cUrl) {
                $$$1(link)
                  .addClass(ClassName.ACTIVE)
                  .parents(Selector.NAV_DROPDOWN_ITEMS)
                  .add(link)
                  .each(function(key, value) {
                    link = value;
                    $$$1(link)
        ...
        _proto._addEventListeners = function _addEventListeners() {
          ...
          $$$1(document).on(Event.CLICK, Selector.BRAND_MINIMIZER, function(
            event
          ) {
            event.preventDefault();
            event.stopPropagation();
          ...
          $$$1(document).on(Event.CLICK, Selector.NAV_DROPDOWN_TOGGLE, function(
            event
          ) {
            event.preventDefault();
            event.stopPropagation();
          ...
          $$$1(document).on(Event.CLICK, Selector.SIDEBAR_MINIMIZER, function(
            event
          ) {
            event.preventDefault();
            event.stopPropagation();
          ...
          $$$1(document).on(Event.CLICK, Selector.SIDEBAR_TOGGLER, function(
            event
          ) {
            event.preventDefault();
            event.stopPropagation();
