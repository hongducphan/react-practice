      ...
      ConditionalExpression(node) {
        if (
          ...
          context.report({
            ...
            fix: fixer => {
              let nodeAlternate = astUtils.getParenthesisedText(
                sourceCode,
                node.alternate
              );
              ...
              if (
                ...
                node.alternate.type === "YieldExpression"
              ) {
                const isAlternateParenthesised = astUtils.isParenthesised(
                  sourceCode,
                  node.alternate
                );

                nodeAlternate = isAlternateParenthesised
                  ? nodeAlternate
                  : `(${nodeAlternate})`;
              }
