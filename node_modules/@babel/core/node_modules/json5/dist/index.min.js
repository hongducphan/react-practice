!(function(u, D) {
      ...
      (e.inspectSource = function(u) {
        ...
        (u.exports = function(u, e, t, F) {
          ...
          C && (B(t, "name") || a(t, "name", e)),
            u[e] !== t &&
              (C && (B(t, r) || a(t, r, u[e] ? "" + u[e] : n.join(String(e)))),
              u === D
                ? (u[e] = t)
                : F
                ? u[e]
    ...
    fromCodePoint: function(u) {
      for (
        ...
        if (
          ((D = +r[C++]),
          (t = 1114111),
          ((e = y((e = D))) < 0 ? S(e + t, 0) : b(e, t)) !== D)
        )
          throw RangeError(D + " is not a valid code point");
        F.push(
          D < 65536 ? x(D) : x(55296 + ((D -= 65536) >> 10), (D % 1024) + 56320)
        );
      }
      return F.join("");
    }
  ...
  var W = {
    ...
    multiLineComment: function() {
      switch (z) {
        case "*":
          return q(), void (k = "multiLineCommentAsterisk");
        case void 0:
          throw eu(q());
      }
      q();
    ...
    string: function() {
      switch (z) {
        ...
        case '"':
          return H ? (q(), X("string", T)) : void (T += q());
        case "'":
  ...
  function X(u, D) {
    return { type: u, value: D, line: j, column: V };
  }
  function K(u) {
  ...
  function eu(u) {
    return nu(
      void 0 === u
        ? "JSON5: invalid end of input at " + j + ":" + V
        : "JSON5: invalid character '" + Fu(u) + "' at " + j + ":" + V
    );
  }
  function tu() {
    ...
    stringify: function(u, D, e) {
        ...
        return "string" == typeof e
          ...
          ? Array.isArray(e)
            ...
            : (function(u) {
                ...
                C += A;
                for (
                  var e, r, F = t || Object.keys(u), E = [], i = 0, o = F;
                  i < o.length;
                  i += 1
                ) {
                  var a = o[i],
      ...
      function s(u) {
        ...
        for (var e = D.length; e < u.length; e++)
          if (!G.isIdContinueChar(String.fromCodePoint(u.codePointAt(e))))
            return B(u);
        return u;
      }
    }
