					...
					n._set("global", {
						...
						(e.exports = {
							...
							cancelAnimation: function(e) {
								var t = o.findIndex(this.animations, function(
									t
								) {
									return t.chart === e;
								});
								...
								if (D.display) {
											...
											if (!H.isNullOrUndef(t.label)) {
												...
												o =
													...
													D.offset ===
														...
														: ((i = H.valueAtIndexOrDefault(
																A.lineWidth,
																e
														  )),
														  (n = H.valueAtIndexOrDefault(
																A.color,
																e
														  )),
														  (a = H.valueOrDefault(
									...
									if (A.drawBorder) {
										(r.lineWidth = H.valueAtIndexOrDefault(
											...
											(r.strokeStyle = H.valueAtIndexOrDefault(
												A.color,
												0
											));
										var p = _.left,
