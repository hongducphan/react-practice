			...
			3: [
				function(require, module, exports) {
					...
					Color.prototype = {
						...
						rgbaString: function() {
							return string.rgbaString(
								this.values.rgb,
								this.values.alpha
							);
						},
						percentString: function() {
							return string.percentString(
								this.values.rgb,
								this.values.alpha
							);
						},
						...
						hslaString: function() {
							return string.hslaString(
								this.values.hsl,
								this.values.alpha
							);
						},
						hwbString: function() {
							return string.hwbString(
								this.values.hwb,
								this.values.alpha
							);
						},
					...
					Color.prototype.setValues = function(space, vals) {
						...
						values.alpha = Math.max(
							...
							Math.min(
								1,
								alpha === undefined ? values.alpha : alpha
							)
						);
						...
						for (var sname in spaces) {
							if (sname !== space) {
								values[sname] = convert[space][sname](
									values[space]
								);
							}
						}
  ...
  compute it */
						...
						Chart.controllers.bar = Chart.DatasetController.extend({
							...
							updateElement: function(rectangle, index, reset) {
								...
								var rectangleOptions =
									chart.options.elements.rectangle;

								rectangle._xScale = me.getScaleForId(
									meta.xAxisID
								);
								rectangle._yScale = me.getScaleForId(
									meta.yAxisID
								);
							...
							updateElementGeometry: function(
								...
								model.y = horizontal
									...
									? base
									: vpixels.head;
								model.height = horizontal
									? ipixels.size
									: undefined;
								model.width = horizontal
									? undefined
									: ipixels.size;
							},
							...
							getRuler: function() {
								...
								var end =
									start +
									(isHorizontal ? scale.width : scale.height);
								var pixels = [];
								var i, ilen, min;

								for (
									i = 0, ilen = me.getMeta().data.length;
									i < ilen;
									++i
								) {
									pixels.push(
								...
								min = helpers.isNullOrUndef(
									scale.options.barThickness
								)
								...
								if (
									...
									for (i = 0; i < datasetIndex; ++i) {
										...
										if (
											imeta.bar &&
											imeta.stack === stack &&
											imeta.controller.getValueScaleId() ===
												scale.id &&
											chart.isDatasetVisible(i)
										) {
											ivalue = scale.getRightValue(
							...
							draw: function() {
								...
								for (; i < ilen; ++i) {
									if (
										!isNaN(
											scale.getRightValue(dataset.data[i])
										)
									) {
										rects[i].draw();
									}
						...
						Chart.controllers.bubble = Chart.DatasetController.extend(
							{
								...
								updateElement: function(point, index, reset) {
									...
									var options = me._resolveElementOptions(
										point,
										index
									);
						...
						legend: {
							...
							onClick: function(e, legendItem) {
								...
								for (
									...
									if (meta.data[index]) {
										meta.data[index].hidden = !meta.data[
											index
										].hidden;
									}
								}
						...
						Chart.controllers.doughnut = Chart.controllers.pie = Chart.DatasetController.extend(
							{
								...
								update: function(reset) {
									...
									helpers.each(meta.data, function(
										arc,
										index
									) {
								...
								updateElement: function(arc, index, reset) {
										...
										reset && animationOpts.animateRotate
											...
											: me.calculateCircumference(
											  ...
											  (opts.circumference /
													(2.0 * Math.PI));
									var innerRadius =
										reset && animationOpts.animateScale
											? 0
											: me.innerRadius;
									var outerRadius =
										reset && animationOpts.animateScale
									...
									var valueOrDefault =
										helpers.valueAtIndexOrDefault;
									var elementOpts = this.chart.options
										.elements.arc;
						...
						Chart.controllers.line = Chart.DatasetController.extend(
							{
								...
								update: function(reset) {
									...
									var lineElementOptions =
										options.elements.line;
									var scale = me.getScaleForId(meta.yAxisID);
									var i, ilen, custom;
									var dataset = me.getDataset();
									var showLine = lineEnabled(
										dataset,
										options
									);
									...
									if (showLine) {
										...
										line._model = {
											...
											borderWidth: custom.borderWidth
												? custom.borderWidth
												: dataset.borderWidth ||
												  lineElementOptions.borderWidth,
											borderColor: custom.borderColor
												? custom.borderColor
												: dataset.borderColor ||
												  lineElementOptions.borderColor,
								...
								getPointBackgroundColor: function(
									...
									var backgroundColor = this.chart.options
								...
								getPointBorderColor: function(point, index) {
									var borderColor = this.chart.options
								...
								getPointBorderWidth: function(point, index) {
									var borderWidth = this.chart.options
								...
								getPointRotation: function(point, index) {
									var pointRotation = this.chart.options
										.elements.point.rotation;
									var dataset = this.getDataset();
									var custom = point.custom || {};
								...
								updateElement: function(point, index, reset) {
									...
									point._model = {
										...
										rotation: me.getPointRotation(
											point,
											index
										),
										backgroundColor: me.getPointBackgroundColor(
											point,
											index
										),
										borderColor: me.getPointBorderColor(
											point,
											index
										),
										borderWidth: me.getPointBorderWidth(
											point,
											index
										),
								...
								calculatePointY: function(
									...
									if (yScale.options.stacked) {
										...
										var rightValue = Number(
											yScale.getRightValue(value)
										);
										if (rightValue < 0) {
											return yScale.getPixelForValue(
												sumNeg + rightValue
											);
										}
										return yScale.getPixelForValue(
								...
								updateBezierControlPoints: function() {
									...
									if (
										...
										for (
											...
											controlPoints = helpers.splineCurve(
												helpers.previousItem(points, i)
													._model,
												model,
												helpers.nextItem(points, i)
													._model,
												meta.dataset._model.tension
											);
									...
									if (
										me.chart.options.elements.line
											.capBezierPoints
									) {
										for (
											i = 0, ilen = points.length;
								...
								draw: function() {
									...
									if (
										...
										halfBorderWidth =
											(meta.dataset._model.borderWidth ||
												0) / 2;
								...
								updateElement: function(point, index, reset) {
									...
									helpers.extend(point, {
										...
										_model: {
											x: reset
												? scale.xCenter
												: pointPosition.x, // value not used in dataset scale, but we want a consistent API between scales
											y: reset
												? scale.yCenter
												: pointPosition.y,
									...
									point._model.skip = custom.skip
										? custom.skip
										: isNaN(point._model.x) ||
										  isNaN(point._model.y);
								},
								updateBezierControlPoints: function() {
				...
				function(require, module, exports) {
					...
					module.exports = {
						...
						startDigest: function() {
							...
							me.dropFrames +=
								(endTime - startTime) / me.frameDuration;
							...
							/** @lends Chart */ {
								...
								resize: function(silent) {
									...
									var newWidth = Math.max(
										0,
										Math.floor(
											helpers.getMaximumWidth(canvas)
										)
									);
								...
								buildOrUpdateScales: function() {
									...
									var items = [];
									var updated = Object.keys(scales).reduce(
										function(obj, id) {
											obj[id] = false;
											return obj;
										},
								...
								buildOrUpdateControllers: function() {
									...
									helpers.each(
										...
										function(dataset, datasetIndex) {
											var meta = me.getDatasetMeta(
												datasetIndex
											);
											var type =
												dataset.type || me.config.type;

											if (
												meta.type &&
												meta.type !== type
											) {
												me.destroyDatasetMeta(
													datasetIndex
												);
												meta = me.getDatasetMeta(
													datasetIndex
												);
											}
											meta.type = type;
								...
								update: function(config) {
									...
									if (
										plugins.notify(me, "beforeUpdate") ===
										false
									) {
										return;
									}
									...
									if (
										me.options.animation &&
										me.options.animation.duration
									) {
								...
								updateLayout: function() {
									...
									if (
										plugins.notify(me, "beforeLayout") ===
										false
									) {
										return;
									}
								...
								render: function(config) {
									...
									if (
										plugins.notify(me, "beforeRender") ===
										false
									) {
										return;
									}
								...
								getElementsAtXAxis: function(e) {
									return Interaction.modes["x-axis"](
										this,
										e,
										{ intersect: true }
									);
								...
								destroyDatasetMeta: function(datasetIndex) {
									...
									var meta =
										dataset._meta && dataset._meta[id];
								...
								destroy: function() {
									...
									for (
										i = 0, ilen = me.data.datasets.length;
										i < ilen;
										++i
									) {
								...
								bindEvents: function() {
									...
									helpers.each(me.options.events, function(
										type
									) {
								...
								unbindEvents: function() {
									...
									helpers.each(listeners, function(
										listener,
										type
									) {
			...
			25: [
				function(require, module, exports) {
					...
					module.exports = function(Chart) {
						...
						Chart.DatasetController = function(
							chart,
							datasetIndex
						) {
						...
						helpers.extend(Chart.DatasetController.prototype, {
							...
							addElements: function() {
								...
								for (i = 0, ilen = data.length; i < ilen; ++i) {
									metaData[i] =
										metaData[i] || me.createMetaData(i);
								}
				...
				function(require, module, exports) {
					...
					module.exports = function() {
						...
						helpers.almostWhole = function(x, epsilon) {
							...
							return (
								rounded - epsilon < x && rounded + epsilon > x
							);
						};
						...
						helpers.getAngleFromPoint = function(
							...
							var distanceFromXCenter =
								anglePoint.x - centrePoint.x;
							var distanceFromYCenter =
								anglePoint.y - centrePoint.y;
						...
						helpers.splineCurveMonotone = function(points) {
							...
							for (i = 0; i < pointsLen - 1; ++i) {
								...
								pointAfter.mK =
									betaK * tauK * pointCurrent.deltaK;
							}
						...
						function getConstraintDimension(
							...
							var constrainedNode = view.getComputedStyle(
								domNode
							)[maxStyle];
							...
							var hasCContainer = isConstrainedValue(
						...
						helpers.measureText = function(
							...
							if (!textWidth) {
								textWidth = data[string] = ctx.measureText(
									string
								).width;
								gc.push(string);
							}
			...
			29: [
				function(require, module, exports) {
					...
					function indexMode(chart, e, options) {
						...
						var distanceMetric = getDistanceMetricForAxis(
							options.axis
						);
				...
				function(require, module, exports) {
					...
					module.exports = {
						...
						removeBox: function(chart, layoutItem) {
							var index = chart.boxes
								? chart.boxes.indexOf(layoutItem)
								: -1;
							if (index !== -1) {
						...
						update: function(chart, width, height) {
							...
							var padding = helpers.options.toPadding(
							...
							var leftBoxes = filterByPosition(
								chart.boxes,
								"left"
							);
							var rightBoxes = filterByPosition(
								chart.boxes,
								"right"
							);
							var topBoxes = filterByPosition(chart.boxes, "top");
							var bottomBoxes = filterByPosition(
								chart.boxes,
								"bottom"
							);
							var chartAreaBoxes = filterByPosition(
								chart.boxes,
								"chartArea"
							);
					...
					module.exports = Element.extend({
						...
						mergeTicksOptions: function() {
							...
							for (var key in ticks) {
								if (key !== "major" && key !== "minor") {
									if (
										typeof ticks.minor[key] === "undefined"
									) {
										ticks.minor[key] = ticks[key];
									}
									if (
										typeof ticks.major[key] === "undefined"
									) {
						...
						calculateTickRotation: function() {
							...
							if (
								...
								var tickWidth =
									me.getPixelForTick(1) -
									me.getPixelForTick(0) -
									6;
								...
								while (
									...
									var angleRadians = helpers.toRadians(
										labelRotation
									);
									...
									if (
										sinRotation * originalLabelWidth >
										me.maxHeight
									) {
										// go back one step
										labelRotation--;
									...
									labelRotation++;
									labelWidth =
										cosRotation * originalLabelWidth;
								}
							}
						...
						fit: function() {
							...
							if (isHorizontal) {
								...
								minSize.width =
									display && gridLineOpts.drawTicks
										? tickMarkLength
										: 0;
							}
							...
							if (scaleLabelOpts.display && display) {
								var scaleLabelLineHeight = parseLineHeight(
									scaleLabelOpts
								);
								...
								var deltaHeight =
									scaleLabelLineHeight +
									scaleLabelPadding.height;
						...
						handleMargins: function() {
							...
							if (me.margins) {
								...
								me.paddingTop = Math.max(
									me.paddingTop - me.margins.top,
									0
								);
						...
						getPixelForTick: function(index) {
							...
							return (
								me.top +
								index * (innerHeight / (me._ticks.length - 1))
							);
						},
						...
						getPixelForDecimal: function(decimal) {
							...
							if (me.isHorizontal()) {
								var innerWidth =
									...
									(me.paddingLeft + me.paddingRight);
								var valueOffset =
									innerWidth * decimal + me.paddingLeft;

								var finalVal =
									me.left + Math.round(valueOffset);
								finalVal += me.isFullWidth()
									? me.margins.left
									: 0;
								return finalVal;
						...
						_autoSkip: function(ticks) {
							...
							var labelRotationRadians = helpers.toRadians(
								me.labelRotation
							);
						...
						draw: function(chartArea) {
							...
							var optionMajorTicks =
								options.ticks.major || optionTicks;
							...
							var majorTickFont = parseFontOptions(
								optionMajorTicks
							);
							...
							helpers.each(itemsToDraw, function(itemToDraw) {
								if (gridLines.display) {
									...
									if (context.setLineDash) {
										context.setLineDash(
											itemToDraw.glBorderDash
										);
										context.lineDashOffset =
											itemToDraw.glBorderDashOffset;
									}
							...
							if (scaleLabel.display) {
								...
								var rotation = 0;
								var halfLineHeight =
									parseLineHeight(scaleLabel) / 2;

								if (isHorizontal) {
									scaleLabelX =
										me.left + (me.right - me.left) / 2; // midpoint of the width
									scaleLabelY =
										options.position === "bottom"
											? me.bottom -
											  halfLineHeight -
							...
							linear: function(tickValue, index, ticks) {
								...
								if (tickValue !== 0) {
									...
									if (maxTick < 1e-4) {
										...
										numDecimal = Math.max(
											Math.min(numDecimal, 20),
											0
										); // toFixed has a max of 20 decimal places
										tickString = tickValue.toFixed(
											numDecimal
										);
									}
								} else {
			...
			36: [
				function(require, module, exports) {
					...
					function getTooltipSize(tooltip, model) {
						...
						widthPadding = model.displayColors
							? bodyFontSize + 2
							: 0;
					...
					var exports = (module.exports = Element.extend({
						...
						getTitle: function() {
							...
							var beforeTitle = callbacks.beforeTitle.apply(
								me,
								arguments
							);
							var title = callbacks.title.apply(me, arguments);
							var afterTitle = callbacks.afterTitle.apply(
								me,
								arguments
							);
						...
						getFooter: function() {
							...
							var beforeFooter = callbacks.beforeFooter.apply(
								me,
								arguments
							);
							var footer = callbacks.footer.apply(me, arguments);
							var afterFooter = callbacks.afterFooter.apply(
								me,
								arguments
							);
						...
						update: function(changed) {
							...
							if (active.length) {
								...
								for (i = 0, len = active.length; i < len; ++i) {
									tooltipItems.push(
										createTooltipItem(active[i])
									);
								}

								// If the user provided a filter function, use it to modify the tooltip items
								if (opts.filter) {
									tooltipItems = tooltipItems.filter(function(
										a
									) {
								...
								if (opts.itemSort) {
									tooltipItems = tooltipItems.sort(function(
										a,
										b
									) {
								...
								helpers.each(tooltipItems, function(
									tooltipItem
								) {
									labelColors.push(
								...
								model.beforeBody = me.getBeforeBody(
									tooltipItems,
									data
								);
								model.body = me.getBody(tooltipItems, data);
								model.afterBody = me.getAfterBody(
									tooltipItems,
									data
								);
						...
						drawTitle: function(pt, vm, ctx, opacity) {
							...
							if (title.length) {
								...
								for (i = 0, len = title.length; i < len; ++i) {
									...
									if (i + 1 === title.length) {
										pt.y +=
											vm.titleMarginBottom - titleSpacing; // If Last, add margin, remove spacing
									}
								}
							}
						},
						...
						drawBody: function(pt, vm, ctx, opacity) {
							...
							xLinePadding = drawColorBoxes
								? bodyFontSize + 2
								: 0;

							// Draw body lines now
							helpers.each(body, function(bodyItem, i) {
								var textColor = mergeOpacity(
						...
						drawFooter: function(pt, vm, ctx, opacity) {
							...
							if (footer.length) {
								...
								helpers.each(footer, function(line) {
									...
									pt.y +=
										vm.footerFontSize + vm.footerSpacing;
								});
							}
						},
				...
				function(require, module, exports) {
					...
					module.exports = Element.extend({
						...
						getCenterPoint: function() {
							...
							var halfRadius =
								(vm.innerRadius + vm.outerRadius) / 2;
							return {
						...
						tooltipPosition: function() {
							...
							var rangeFromCentre =
								(vm.outerRadius - vm.innerRadius) / 2 +
								vm.innerRadius;
				...
				function(require, module, exports) {
					...
					module.exports = Element.extend({
						draw: function() {
							...
							var globalOptionLineElements =
								globalDefaults.elements.line;
				...
				function(require, module, exports) {
					...
					var helpers = {
						...
						_merger: function(key, target, source, options) {
							...
							if (
								helpers.isObject(tval) &&
								helpers.isObject(sval)
							) {
			...
			48: [
				function(require, module, exports) {
					...
					function initCanvas(canvas, config) {
						...
						if (renderHeight === null || renderHeight === "") {
							if (canvas.style.height === "") {
								...
								var displayHeight = readUsedSize(
									canvas,
									"height"
								);
								if (displayWidth !== undefined) {
					...
					function watchForRender(node, handler) {
						var expando =
							node[EXPANDO_KEY] || (node[EXPANDO_KEY] = {});
					...
					function unwatchForRender(node) {
						...
						if (proxy) {
							helpers.each(ANIMATION_START_EVENTS, function(
								type
							) {
					...
					function injectCSS(platform, css) {
						...
						var style =
							platform._style || document.createElement("style");
						if (!platform._style) {
					...
					module.exports = {
						...
						releaseContext: function(context) {
							...
							helpers.each(initial.style || {}, function(
								value,
								key
							) {
						...
						addEventListener: function(chart, type, listener) {
							...
							var expando =
								...
								(listener[EXPANDO_KEY] = {});
							var proxies =
								expando.proxies || (expando.proxies = {});
							var proxy = (proxies[
								chart.id + "_" + type
							] = function(event) {
				...
				function(require, module, exports) {
					...
					var mappers = {
						dataset: function(source) {
							...
							var points =
								(visible && meta.dataset._children) || [];
							...
							labels: {
								...
								generateLabels: function(chart) {
									...
									return helpers.isArray(data.datasets)
										? data.datasets.map(function(
												dataset,
												i
										  ) {
												return {
													text: dataset.label,
													fillStyle: !helpers.isArray(
														dataset.backgroundColor
													)
														? dataset.backgroundColor
														: dataset
								...
								if (isHorizontal) {
									...
									helpers.each(me.legendItems, function(
										...
										var width =
											boxWidth +
											fontSize / 2 +
											ctx.measureText(legendItem.text)
												.width;
						...
						draw: function() {
							...
							if (opts.display) {
								...
								var drawLegendBox = function(x, y, legendItem) {
									...
									if (
										opts.labels &&
										opts.labels.usePointStyle
									) {
										// Recalculate x and y for drawPoint() because its expecting
										// x and y to be center of figure (instead of top left)
										var radius =
											(fontSize * Math.SQRT2) / 2;
										var offSet = radius / Math.SQRT2;
					...
					module.exports = function() {
						...
						var DatasetScale = Scale.extend({
							...
							getValueForPixel: function(pixel) {
								...
								var valueDimension =
									(horz ? me.width : me.height) / offsetAmt;
						...
						var LinearScale = Chart.LinearScaleBase.extend({
							determineDataLimits: function() {
								...
								if (hasStacks === undefined) {
									helpers.each(datasets, function(
										dataset,
										datasetIndex
									) {
										if (hasStacks) {
								...
								if (opts.stacked || hasStacks) {
									...
									helpers.each(datasets, function(
										...
										var positiveValues =
											valuesPerStack[key].positiveValues;
										var negativeValues =
											valuesPerStack[key].negativeValues;
									...
									helpers.each(valuesPerStack, function(
										valuesForType
									) {
								...
								me.min =
									isFinite(me.min) && !isNaN(me.min)
										? me.min
										: DEFAULT_MIN;
								me.max =
									isFinite(me.max) && !isNaN(me.max)
										? me.max
										: DEFAULT_MAX;
			...
			56: [
				function(require, module, exports) {
					...
					function generateTicks(generationOptions, dataRange) {
						...
						var niceMin =
							Math.floor(dataRange.min / spacing) * spacing;
						var niceMax =
							Math.ceil(dataRange.max / spacing) * spacing;
						...
						if (spacing < 1) {
							precision = Math.pow(
								10,
								1 - Math.floor(helpers.log10(spacing))
							);
							niceMin =
								Math.round(niceMin * precision) / precision;
							niceMax =
								Math.round(niceMax * precision) / precision;
						}
						ticks.push(
					...
					module.exports = function(Chart) {
						...
						Chart.LinearScaleBase = Scale.extend({
							getRightValue: function(value) {
								...
								return Scale.prototype.getRightValue.call(
									this,
									value
								);
							},
				...
				function(require, module, exports) {
					...
					function generateTicks(generationOptions, dataRange) {
						...
						var tickVal = valueOrDefault(
							...
							Math.pow(
								10,
								Math.floor(helpers.log10(dataRange.min))
							)
						);
						...
						if (tickVal === 0) {
							exp = Math.floor(
								helpers.log10(dataRange.minNotZero)
							);
							...
							significand = Math.floor(
								tickVal / Math.pow(10, exp)
							);
						}
						var precision =
							exp < 0 ? Math.pow(10, Math.abs(exp)) : 1;
						...
						do {
							...
							tickVal =
								Math.round(
									significand * Math.pow(10, exp) * precision
								) / precision;
						} while (
							exp < endExp ||
					...
					module.exports = function(Chart) {
						...
						var LogarithmicScale = Scale.extend({
								...
								if (opts.stacked || hasStacks) {
									...
									helpers.each(valuesPerStack, function(
										...
										if (valuesForType.length > 0) {
											var minVal = helpers.min(
												valuesForType
											);
											var maxVal = helpers.max(
												valuesForType
											);
											me.min =
												me.min === null
							...
							handleTickRangeOptions: function() {
								...
								if (me.min === me.max) {
									if (me.min !== 0 && me.min !== null) {
										me.min = Math.pow(
											10,
											Math.floor(helpers.log10(me.min)) -
												1
										);
										me.max = Math.pow(
											10,
							...
							getPixelForValue: function(value) {
								...
								var firstTickValue = me._getFirstTickValue(
									me.minNotZero
								);
								var offset = 0;
				...
				function(require, module, exports) {
					...
					module.exports = function(Chart) {
						...
						function getValueCount(scale) {
							...
							return opts.angleLines.display ||
						...
						function fitWithPointLabels(scale) {
							...
							for (i = 0; i < valueCount; i++) {
								...
								var angle =
									helpers.toDegrees(angleRadians) % 360;
						...
						function drawPointLabels(scale) {
							...
							for (
								var i = getValueCount(scale) - 1;
								i >= 0;
								i--
							) {
								if (angleLineOpts.display) {
									var outerPosition = scale.getPointPosition(
										i,
										outerDistance
									);
									ctx.beginPath();
						...
						function drawRadiusLine(
							...
							if (scale.options.gridLines.circular) {
								...
								ctx.beginPath();
								var pointPosition = scale.getPointPosition(
									0,
									radius
								);
						...
						var LinearRadialScale = Chart.LinearScaleBase.extend({
							...
							getTickLimit: function() {
								...
								return Math.min(
									tickOpts.maxTicksLimit
										...
										: 11,
									Math.ceil(
										this.drawingArea / (1.5 * tickFontSize)
									)
								);
							},
							convertTicksToLabels: function() {
								...
								Chart.LinearScaleBase.prototype.convertTicksToLabels.call(
									me
								);
							...
							setReductions: function(
								...
								radiusReductionLeft = numberOrZero(
									radiusReductionLeft
								);
								radiusReductionRight = numberOrZero(
									radiusReductionRight
								);
								radiusReductionTop = numberOrZero(
									radiusReductionTop
								);
								radiusReductionBottom = numberOrZero(
							...
							setCenterPoint: function(
								...
								var me = this;
								var maxRight =
									me.width - rightMovement - me.drawingArea;
								var maxLeft = leftMovement + me.drawingArea;
								var maxTop = topMovement + me.drawingArea;
								var maxBottom =
									me.height - bottomMovement - me.drawingArea;

								me.xCenter = Math.round(
									(maxLeft + maxRight) / 2 + me.left
								);
								me.yCenter = Math.round(
									(maxTop + maxBottom) / 2 + me.top
								);
							},

							getIndexAngle: function(index) {
								var angleMultiplier =
									(Math.PI * 2) / getValueCount(this);
								var startAngle =
									this.chart.options &&
								...
								var startAngleRadians =
									(startAngle * Math.PI * 2) / 360;

								// Start from the top instead of right, so remove a quarter of the circle
								return (
									index * angleMultiplier + startAngleRadians
								);
							},
							...
							draw: function() {
								...
								if (opts.display) {
									...
									helpers.each(me.ticks, function(
										label,
										index
									) {
			...
			59: [
				function(require, module, exports) {
					...
					moment =
						typeof moment === "function" ? moment : window.moment;
					...
					function determineStepSize(min, max, unit, capacity) {
						...
						for (i = 0, ilen = steps.length; i < ilen; ++i) {
							factor = steps[i];
							if (
								Math.ceil(range / (milliseconds * factor)) <=
								capacity
							) {
								break;
							}
					...
					function generate(min, max, capacity, options) {
						...
						var weekday =
							minor === "week" ? timeOpts.isoWeekday : false;
					...
					module.exports = function() {
						...
						var TimeScale = Scale.extend({
							...
							update: function() {
								...
								return Scale.prototype.update.apply(
									me,
									arguments
								);
							},
							...
							determineDataLimits: function() {
								...
								for (
									i = 0, ilen = chart.data.labels.length;
									i < ilen;
									++i
								) {
									labels.push(
										parse(chart.data.labels[i], me)
									);
								}
								...
								if (timestamps.length) {
									timestamps = arrayUnique(timestamps).sort(
										sorter
									);
							...
							getPixelForValue: function(
								...
								if (
									...
									time =
										me._timestamps.datasets[datasetIndex][
											index
										];
								}
							...
							getLabelWidth: function(label) {
								...
								var tickLabelWidth = me.ctx.measureText(label)
									.width;
								var angle = helpers.toRadians(
							...
							getLabelCapacity: function(exampleTime) {
								...
								var formatOverride =
									me.options.time.displayFormats.millisecond; // Pick the longest format for guestimation
								...
								var tickLabelWidth = me.getLabelWidth(
									exampleLabel
								);
