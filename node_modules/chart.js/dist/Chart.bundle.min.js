				...
				function(t, e, n) {
					...
					function o(t) {
						...
						return [
							...
							100 *
								(i =
									1 - (1 / 255) * Math.max(e, Math.max(n, i)))
						];
					}
					function s(t) {
						var e,
					...
					(e = this),
						(n = function() {
							...
							function b(t) {
								if (null == t._isValid) {
									var e = v(t),
										n = a.call(e.parsedDateParts, function(
											t
										) {
											return null != t;
										}),
							...
							function Rt(t, e) {
								...
								if ("string" == typeof e)
									if (/^\d+$/.test(e)) e = M(e);
										...
										!d((e = t.localeData().monthsParse(e)))
									)
										return t;
								return (
									...
									n &&
										...
										((e =
											n[mt] < 0 || 11 < n[mt]
												...
												? xt
												: -1),
										v(t)._overflowDayOfYear &&
											(e < gt || pt < e) &&
											(e = pt),
										v(t)._overflowWeeks &&
											-1 === e &&
											(e = _t),
										v(t)._overflowWeekday &&
											-1 === e &&
											(e = kt),
										(v(t).overflow = e)),
									t
									...
									if (t._f !== c.RFC_2822) {
										...
										(v(t).charsLeftOver = d - h),
											...
											t._a[vt] <= 12 &&
												...
												0 < t._a[vt] &&
												(v(t).bigHour = void 0),
											(v(t).parsedDateParts = t._a.slice(
												0
											)),
							...
							B(0, ["gg", 2], 0, function() {
								...
								lt("GGGGG", et, X),
								lt("ggggg", et, X),
								ft(["gggg", "ggggg", "GGGG", "GGGGG"], function(
									t,
									e,
									n,
									i
							...
							(hn.calendar = function(t, e, n) {
								...
								(hn.week = function(t) {
									return Bt(t, this._week.dow, this._week.doy)
										.week;
								}),
								...
								(hn.weekdaysParse = function(t, e, n) {
									...
									for (
										...
										if (
											...
											n &&
												"dddd" === e &&
												this._fullWeekdaysParse[i].test(
													t
												))
										)
											return i;
							...
							(e.controllers.bar = e.DatasetController.extend({
								...
								draw: function() {
									...
									for (
										...
										isNaN(e.getRightValue(i.data[r])) ||
											n[r].draw();
							...
							t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend(
								{
									...
									update: function(n) {
										...
										(t.borderWidth = i.getMaxBorderWidth(
											d.data
										)),
								...
								updateBezierControlPoints: function() {
									...
									if (
										...
										for (t = 0, e = o.length; t < e; ++t)
											((n =
												o[t]
													._model).controlPointPreviousX = s(
												n.controlPointPreviousX,
												r.left,
												r.right
											)),
							...
							t.controllers.radar = t.DatasetController.extend({
								...
								updateBezierControlPoints: function() {
									...
									u.each(r.data, function(t, e) {
										var n = t._model,
											i = u.splineCurve(
												u.previousItem(r.data, e, !0)
													._model,
												n,
												u.nextItem(r.data, e, !0)
													._model,
												n.tension
											);
					...
					i._set("global", {
						...
						(e.exports = {
							...
							cancelAnimation: function(e) {
								var t = r.findIndex(this.animations, function(
									t
								) {
									return t.chart === e;
								});
							...
							c.extend(u.prototype, {
								...
								resize: function(t) {
									var e = this,
										...
										r = Math.max(
											0,
											Math.floor(c.getMaximumWidth(i))
										),
										o = Math.max(
											0,
											Math.floor(
						...
						(t.DatasetController = function(t, e) {
							...
							s.extend(t.DatasetController.prototype, {
								...
								addElements: function() {
									...
									n.dataset =
										n.dataset || this.createMetaDataset();
								},
					...
					e.exports = function() {
						...
						(g.configMerge = function() {
							...
							(g.getRelativePosition = function(t, e) {
								...
								var l = parseFloat(
										g.getStyle(r, "padding-left")
									),
									u = parseFloat(
										g.getStyle(r, "padding-top")
									),
									d = parseFloat(
										g.getStyle(r, "padding-right")
									),
									h = parseFloat(
										g.getStyle(r, "padding-bottom")
									),
					...
					x._set("scale", {
						...
						(e.exports = i.extend({
							...
							beforeSetDimensions: function() {
								B.callback(this.options.beforeSetDimensions, [
									this
								]);
							},
							...
							afterSetDimensions: function() {
								B.callback(this.options.afterSetDimensions, [
									this
								]);
							},
							beforeDataLimits: function() {
								B.callback(this.options.beforeDataLimits, [
									this
								]);
							},
							determineDataLimits: B.noop,
							afterDataLimits: function() {
								B.callback(this.options.afterDataLimits, [
									this
								]);
							},
							beforeBuildTicks: function() {
								B.callback(this.options.beforeBuildTicks, [
									this
								]);
							},
							buildTicks: B.noop,
							afterBuildTicks: function() {
								B.callback(this.options.afterBuildTicks, [
									this
								]);
							},
							...
							fit: function() {
								...
								if (
									...
									var h =
										M(r) +
										B.options.toPadding(r.padding).height;
							...
							draw: function(S) {
								...
								if (C.display) {
											...
											if (!B.isNullOrUndef(t.label)) {
												...
												r =
													...
													C.offset ===
														...
														: ((n = B.valueAtIndexOrDefault(
																O.lineWidth,
																e
														  )),
														  (i = B.valueAtIndexOrDefault(
																O.color,
																e
														  )),
														  (a = B.valueOrDefault(
									...
									if (O.drawBorder) {
										(o.lineWidth = B.valueAtIndexOrDefault(
											O.lineWidth,
											0
										)),
											(o.strokeStyle = B.valueAtIndexOrDefault(
												O.color,
												0
											));
										var m = D.left,
							...
							if (S.length) {
								...
								for (e = 0, n = S.length; e < n; ++e)
									F.push(
										...
										{
											xLabel: v
												? v.getLabelForIndex(y, x)
												: "",
											yLabel: b
												? b.getLabelForIndex(y, x)
												: "",
											index: y,
											datasetIndex: x,
											x: p._model.x,
								...
								k.filter &&
									...
									R.each(F, function(t) {
										I.push(
											...
											A.push(
												k.callbacks.labelTextColor.call(
													_,
													t,
													_._chart
												)
							...
							a.length &&
								...
								R.each(a, function(t) {
									i.fillText(t, e.x, e.y),
										(e.y +=
											n.footerFontSize + n.footerSpacing);
								}));
						},
				...
				function(t, e, n) {
					...
					function x(t, e, n, i, a) {
						...
						if (i && a) {
							...
							for (
								t.lineTo(n[a - 1].x, n[a - 1].y), r = a - 1;
								0 < r;
								--r
							)
						...
						var e = {
							...
							n = t.LinearScaleBase.extend({
								determineDataLimits: function() {
									...
									(o.min =
										isFinite(o.min) && !isNaN(o.min)
											? o.min
											: 0),
										(o.max =
											isFinite(o.max) && !isNaN(o.max)
												? o.max
												: 1),
									...
									var e = this.isHorizontal(),
										...
										i =
											(e
												...
												: this.bottom - t) / n;
									return (
										this.start + (this.end - this.start) * i
									);
								},
								getPixelForTick: function(t) {
									return this.getPixelForValue(
							...
							e = i.extend({
								...
								convertTicksToLabels: function() {
									(this.tickValues = this.ticks.slice()),
										i.prototype.convertTicksToLabels.call(
											this
										);
								},
								getLabelForIndex: function(t, e) {
								...
								getValueForPixel: function(t) {
									...
									if (
										...
										(a = r.isHorizontal()
											? ((e = r.width),
											  o ? r.right - t : t - r.left)
											: ((e = r.height),
											  o ? t - r.top : r.bottom - t)) !==
											n)
									) {
										if (0 === n) {
						...
						var n = t.LinearScaleBase.extend({
							...
							determineDataLimits: function() {
								...
								_.each(n.data.datasets, function(t, e) {
									...
									(a.min =
										r === Number.POSITIVE_INFINITY ? 0 : r),
									(a.max =
										o === Number.NEGATIVE_INFINITY ? 0 : o),
							...
							getPointPosition: function(t, e) {
								...
								return {
									x:
										Math.round(Math.cos(n) * e) +
										this.xCenter,
									y:
										Math.round(Math.sin(n) * e) +
										this.yCenter
								};
							},
						...
						var t = i.extend({
							...
							determineDataLimits: function() {
								var t,
									...
									g = [];
								for (
									t = 0, n = s.data.labels.length;
									t < n;
									++t
								)
									g.push(S(s.data.labels[t], o));
								for (
									t = 0, n = (s.data.datasets || []).length;
									t < n;
									++t
								)
							...
							getLabelCapacity: function(t) {
								var e = this.options.time.displayFormats
										.millisecond,
