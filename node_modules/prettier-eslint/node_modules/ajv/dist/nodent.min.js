...
})(
  {
          ...
          e.extend("initialContext", function(r) {
                  ...
                  if (i(u, this, !0)) {
                    ...
                    try {
                      return (
                        ...
                        this.next(),
                        ((l = this.parseStatement(n, r)).async = !0),
                        (l.start = s),
                        l.loc && (l.loc.start = o),
                        l.range && (l.range[0] = s),
                        l
              ...
              return function(i) {
                ...
                if ("Identifier" === p.type)
                  if ("async" !== p.name || r(this, p.end)) {
                    if ("await" === p.name) {
                      var h = this.startNodeAt(p.start, p.loc && p.loc.start);
                      ...
                      if (this.input.slice(p.end).match(c))
                      ...
                      if (
                        ...
                        t.awaitAnywhere &&
                        ((u = this.start),
                        (a = s(this, u - 4).parseExprSubscripts()).end <= u)
                      )
                        return (
                          (a = s(this, u).parseExprSubscripts()),
                          (h.operator = "await"),
                          (h.argument = a),
                          (h = this.finishNodeAt(
                            h,
                    ...
                    try {
                        ...
                        m = {
                          parseFunctionBody: function(e, t) {
                            try {
                              ...
                              return (
                                (y = !0),
                                d.parseFunctionBody.apply(this, arguments)
                              );
                            } finally {
                              y = n;
                            }
                          ...
                          raise: function() {
                            try {
                              return d.raise.apply(this, arguments);
                            } catch (e) {
                              throw y ? e : o;
                            }
                          }
                      ...
                      if (
                        ("SequenceExpression" ===
                          (a = s(this, this.start, m, !0).parseExpression())
                            .type && (a = a.expressions[0]),
                        "CallExpression" === a.type && (a = a.callee),
                        ...
                        return (
                          "SequenceExpression" ===
                            (a = s(this, this.start, m).parseExpression())
                              .type && (a = a.expressions[0]),
                          "CallExpression" === a.type && (a = a.callee),
                          (a.async = !0),
                          (a.start = u),
            ...
            e.extend("finishNodeAt", function(e) {
              return function(t, n, r, i) {
                return (
                  t.__asyncValue &&
                    (delete t.__asyncValue, (t.value.async = !0)),
                  e.apply(this, arguments)
                );
              };
            }),
                ...
                return (
                  "Identifier" !== i.type ||
                    ...
                    (p.test(this.input.slice(i.end))
                      ? ((i = e.apply(this, arguments)), (t.__asyncValue = !0))
                      : (n(t),
                        "set" === t.kind &&
                          this.raise(
                            i.start,
                        ...
                        "Identifier" === (i = e.apply(this, arguments)).type &&
                          "set" === i.name &&
                          this.raise(
                            i.start,
                            "'set <member>(value)' cannot be be async"
            ...
            e.extend("parseMethod", function(e) {
              return function(t) {
                ...
                this.__currentProperty &&
                  ...
                  ((n = this.inAsyncFunction), (this.inAsyncFunction = !0));
            ...
            e.extend("parsePropertyValue", function(e) {
              return function(t, n, r, i, s, o) {
                ...
                var u;
                t.__asyncValue &&
                  ((u = this.inAsyncFunction), (this.inAsyncFunction = !0));
                var c = e.apply(this, arguments);
                return (
                  (this.inAsyncFunction = u), (this.__currentProperty = a), c
                );
              };
            });
        };
      ...
      function(e, t, n) {
        function r(e, t, n) {
          ...
          var s = e,
            o = r;
          return (
            ["inFunction", "inAsync", "inGenerator", "inModule"].forEach(
              function(e) {
                e in s && (o[e] = s[e]);
              }
            ),
        ...
        t.exports = function(e, t) {
          (t && "object" == typeof t) || (t = {}),
            ...
            e.extend("parseStatement", function(e) {
              return function(n, r) {
                ...
                if (
                  ...
                  (function(e, t, n) {
                    var r = t.input.slice(t.start);
                    return n && (r = r.replace(o, "$1 $3")), e.test(r);
                  })(i, this)
                ) {
                  this.next();
            ...
            e.extend("parseExprAtom", function(e) {
              ...
              return function(i) {
                var s,
                  o = this.start,
                  a = (this.startLoc, e.apply(this, arguments));
                if (
                  "Identifier" === a.type &&
                  "await" === a.name &&
                  !this.inAsync &&
                  ...
                  var u = this.startNodeAt(a.start, a.loc && a.loc.start);
                  o = this.start;
                  var c = {
                    raise: function() {
                      try {
                  ...
                  try {
                    if ((s = r(this, o - 4, c).parseExprSubscripts()).end <= o)
                      return (
                        (s = r(this, o, c).parseExprSubscripts()),
                        (u.argument = s),
                        (u = this.finishNodeAt(
                          u,
                          "AwaitExpression",
          ...
          e.extend("parsePropertyName", function(e) {
            return function(t) {
              ...
              return (
                "get" === this.value && (t.__maybeStaticAsyncGetter = !0),
                n[this.value]
                  ? i
                  : ("Identifier" !== i.type ||
    ...
    4: [
      function(e, t, n) {
        !(function(e, r) {
                  ...
                  (!(e < 65) &&
                    (e < 91 ||
                      (e < 97
                        ...
                        : e < 123 ||
                          (e <= 65535
                            ? e >= 170 && w.test(String.fromCharCode(e))
                            : !1 !== n && (t(e, E) || t(e, S))))));
          }
          function i(e, t) {
          ...
          function s(e, t) {
            return (
              void 0 === t && (t = {}), (t.keyword = e), (_[e] = new k(e, t))
            );
          }
          function o(e) {
              ...
              R(t.onComment) &&
                (t.onComment = (function(e, t) {
                  return function(n, r, i, s, o, a) {
                    ...
                    e.locations && (u.loc = new j(this, o, a)),
          ...
          var y = {
            ...
            g = { 5: m, 6: m + " const class extends export import super" },
            v =
          ...
          var j = function(e, t, n) {
            ...
            V = function(e, t, n) {
              (this.options = e = c(e)),
                ...
                (this.keywords = l(g[e.ecmaVersion >= 6 ? 6 : 5]));
              var r = "";
              if (!e.allowReserved) {
              ...
              (this.reservedWordsStrict = l(s)),
                (this.reservedWordsStrictBind = l(s + " " + y.strictBind)),
                (this.input = String(t)),
                (this.containsEsc = !1),
          ...
          (z.isLet = function() {
            ...
            if (n(i, !0)) {
              for (var s = t + 1; r(this.input.charCodeAt(s), !0); ) ++s;
            ...
            (z.isAsyncFunction = function() {
              ...
              return !(
                ...
                (t + 8 != this.input.length && r(this.input.charAt(t + 8)))
              );
            }),
            (z.parseStatement = function(e, t, n) {
              var r,
                i = this.type,
                s = this.startNode();
              switch ((this.isLet() && ((i = L._var), (r = "let")), i)) {
                case L._break:
                case L._continue:
                ...
                default:
                  if (this.isAsyncFunction() && e)
                    return this.next(), this.parseFunctionStatement(s, !0);
                  var o = this.value,
            ...
            (z.parseForStatement = function(e) {
              ...
              var t = this.isLet();
              if (this.type === L._var || this.type === L._const || t) {
          ...
          (z.parseTryStatement = function(e) {
            ...
            (z.parseFor = function(e, t) {
              return (
                (e.init = t),
                this.expect(L.semi),
                (e.test = this.type === L.semi ? null : this.parseExpression()),
                this.expect(L.semi),
                (e.update =
                  this.type === L.parenR ? null : this.parseExpression()),
                this.expect(L.parenR),
                this.exitLexicalScope(),
                (e.body = this.parseStatement(!1)),
                this.labels.pop(),
            ...
            (z.parseForIn = function(e, t) {
              var n = this.type === L._in ? "ForInStatement" : "ForOfStatement";
              return (
                this.next(),
                (e.left = t),
                ...
                if (
                  ...
                  this.eat(L.eq)
                    ...
                    ? "Identifier" == r.id.type ||
                      (t && (this.type === L._in || this.isContextual("of")))
                      ? (r.init = null)
                      : this.raise(
                          this.lastTokEnd,
            ...
            (z.parseFunction = function(e, t, n, r) {
              ...
              return (
                ...
                (this.inFunction = !0),
                this.enterFunctionScope(),
                t || (e.id = this.type == L.name ? this.parseIdent() : null),
            ...
            (z.parseClass = function(e, t) {
              ...
              var n = this.startNode(),
                r = !1;
              for (n.body = [], this.expect(L.braceL); !this.eat(L.braceR); )
                if (!this.eat(L.semi)) {
                  var i = this.startNode(),
                    s = this.eat(L.star),
                    o = !1,
                    a = this.type === L.name && "static" === this.value;
                  this.parsePropertyName(i),
                    (i.static = a && this.type !== L.parenL),
                    i.static &&
                      (s && this.unexpected(),
                      (s = this.eat(L.star)),
                      this.parsePropertyName(i)),
            ...
            (z.parseExportSpecifiers = function(e) {
              ...
              for (this.expect(L.braceL); !this.eat(L.braceR); ) {
                if (n) n = !1;
                  ...
                  (this.expect(L.comma), this.afterTrailingComma(L.braceR))
                )
                  break;
                var r = this.startNode();
              ...
              if (this.options.ecmaVersion >= 6)
                switch (this.type) {
                  case L.bracketL:
                    ...
                    return (
                      this.next(),
                      (e.elements = this.parseBindingList(L.bracketR, !0, !0)),
          ...
          (Y.checkPropClash = function(e, t) {
            ...
            (Y.parseMaybeAssign = function(e, t, n) {
              ...
              if ((n && (u = n.call(this, u, o, a)), this.type.isAssign)) {
                this.checkPatternErrors(t, !0), r || p.call(t);
                var c = this.startNodeAt(o, a);
                return (
                  (c.operator = this.value),
                  (c.left = this.type === L.eq ? this.toAssignable(u) : u),
                  (t.shorthandAssign = -1),
                  this.checkLVal(u),
                  this.next(),
            ...
            (Y.parseExprOp = function(e, t, n, r, i) {
              ...
              if (null != s && (!i || this.type !== L._in) && s > r) {
                var o = this.type === L.logicalOR || this.type === L.logicalAND,
                  a = this.value;
                this.next();
                var u = this.start,
                  c = this.startLoc,
            ...
            (Y.parseSubscripts = function(e, t, n, r) {
              for (
                ...
                if ((s = this.eat(L.bracketL)) || this.eat(L.dot)) {
                  ...
                  if (i && !this.canInsertSemicolon() && this.eat(L.arrow))
                    return (
                      this.checkPatternErrors(a, !1),
                      this.checkYieldAwaitInDefaultParams(),
                      (this.yieldPos = u),
                      (this.awaitPos = c),
                      this.parseArrowExpression(this.startNodeAt(t, n), l, !0)
                    );
                  ...
                  (h.callee = e),
                    (h.arguments = l),
                    (e = this.finishNode(h, "CallExpression"));
                } else {
            ...
            (Y.parseExprAtom = function(e) {
              ...
              switch (this.type) {
                ...
                case L.name:
                  var r = this.start,
                    i = this.startLoc,
                    s = this.parseIdent(this.type !== L.name);
                  if (
                    this.options.ecmaVersion >= 8 &&
                    "async" === s.name &&
                    !this.canInsertSemicolon() &&
                ...
                case L.parenL:
                  ...
                  return (
                    e &&
                      ...
                      e.parenthesizedBind < 0 && (e.parenthesizedBind = a)),
                    u
                  );
                case L.bracketL:
                  return (
                    (t = this.startNode()),
                    this.next(),
                    (t.elements = this.parseExprList(L.bracketR, !0, !0, e)),
              ...
              if (this.options.ecmaVersion >= 6) {
                ...
                for (
                  ...
                  if (
                    ...
                    i && this.afterTrailingComma(L.parenR, !0))
                  ) {
                    h = !0;
                    break;
                  }
                  ...
                  this.type !== L.parenL || o || (o = this.start),
                ...
                if (
                  (this.expect(L.parenR),
                  e && !this.canInsertSemicolon() && this.eat(L.arrow))
                )
                  return (
                ...
                (c.length && !h) || this.unexpected(this.lastTokStart),
                  ...
                  c.length > 1
                    ? (((t = this.startNodeAt(a, u)).expressions = c),
          ...
          (Y.parseNew = function() {
            ...
            (Y.parseProperty = function(e, t) {
              ...
              return (
                ...
                !e && this.options.ecmaVersion >= 8 && !n && this.isAsyncProp(o)
            ...
            (Y.parseFunctionBody = function(e, t) {
              ...
              if (n)
                ...
                (this.labels = []),
                  ...
                  this.checkParams(
                    e,
                    !r && !i && !t && this.isSimpleParamList(e.params)
                  ),
            ...
            (Y.parseExprList = function(e, t, n, r) {
              for (var i = [], s = !0; !this.eat(e); ) {
                if (s) s = !1;
                  ...
                  (this.expect(L.comma), t && this.afterTrailingComma(e))
                )
                  break;
                var o = void 0;
                n && this.type === L.comma
          ...
          (te.startNode = function() {
            ...
            (te.finishNode = function(e, t) {
              return h.call(this, e, t, this.lastTokEnd, this.lastTokEndLoc);
            }),
          ...
          (ie.initialContext = function() {
            ...
            (ie.braceIsBlock = function(e) {
              ...
              return (
                t === re.f_expr ||
                t === re.f_stat ||
                (e !== L.colon || (t !== re.b_stat && t !== re.b_expr)
                  ? e === L._return || (e == L.name && this.exprAllowed)
                    ? O.test(this.input.slice(this.lastTokEnd, this.start))
                    : e === L._else ||
                      e === L.semi ||
                      e === L.eof ||
                      ...
                      (e == L.braceL
                        ? t === re.b_stat
                        : e != L._var && e != L.name && !this.exprAllowed)
                  : !t.isExpr)
              );
            }),
            ...
            (L.braceL.updateContext = function(e) {
              this.context.push(this.braceIsBlock(e) ? re.b_stat : re.b_expr),
                (this.exprAllowed = !0);
            }),
            ...
            (L.parenL.updateContext = function(e) {
              var t =
                e === L._if || e === L._for || e === L._with || e === L._while;
          ...
          (oe.next = function() {
            this.options.onToken && this.options.onToken(new se(this)),
            ...
            "undefined" != typeof Symbol &&
              (oe[Symbol.iterator] = function() {
                ...
                return {
                  next: function() {
                    var t = e.getToken();
                    return { done: t.type === L.eof, value: t };
                  }
                };
              }),
            ...
            (oe.readToken = function(e) {
              return n(e, this.options.ecmaVersion >= 6) || 92 === e
                ? this.readWord()
            ...
            (oe.skipBlockComment = function() {
              ...
              if (
                ...
                T.lastIndex = t;
                for (var r; (r = T.exec(this.input)) && r.index < this.pos; )
                ...
                switch (e) {
                  ...
                  default:
                    if (
                      !(
                        (e > 8 && e < 14) ||
                        (e >= 5760 && N.test(String.fromCharCode(e)))
                      )
                    )
                      break e;
                    ++this.pos;
            ...
            (oe.readToken_mult_modulo_exp = function(e) {
              ...
              return (
                ...
                61 === t ? this.finishOp(L.assign, n + 1) : this.finishOp(r, n)
              );
            }),
            (oe.readToken_pipe_amp = function(e) {
              var t = this.input.charCodeAt(this.pos + 1);
              return t === e
                ? this.finishOp(124 === e ? L.logicalOR : L.logicalAND, 2)
                : 61 === t
                ? this.finishOp(L.assign, 2)
                : this.finishOp(124 === e ? L.bitwiseOR : L.bitwiseAND, 1);
            }),
            ...
            (oe.readToken_lt_gt = function(e) {
              ...
              return t === e
                ...
                ? (61 === t && (n = 2), this.finishOp(L.relational, n))
            ...
            (oe.readToken_eq_excl = function(e) {
              ...
              return 61 === t
                ...
                : this.finishOp(61 === e ? L.eq : L.prefix, 1);
            }),
            (oe.getTokenFromCode = function(e) {
              switch (e) {
                ...
                case 63:
                  return ++this.pos, this.finishToken(L.question);
                case 96:
          ...
          (oe.readRegexp = function() {
            for (var e, t, n = this, r = this.pos; ; ) {
              ...
              if (
                (O.test(i) && n.raise(r, "Unterminated regular expression"), e)
              )
                e = !1;
              else {
                if ("[" === i) t = !0;
            ...
            if (o) {
              ...
              this.options.ecmaVersion >= 6 && (c = /^[gimuy]*$/),
                c.test(o) || this.raise(r, "Invalid regular expression flag"),
                o.indexOf("u") >= 0 &&
                  (ue
                    ? (u = "u")
                    : ((a = (a = a.replace(/\\u\{([0-9a-fA-F]+)\}/g, function(
                        e,
                        t,
                        i
                      ) {
                        return (
                          (t = Number("0x" + t)) > 1114111 &&
                            n.raise(r + i + 3, "Code point out of bounds"),
                          "x"
                        );
                      })).replace(
                        /\\u([a-fA-F0-9]{4})|[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
            ...
            return (
              ...
              this.finishToken(L.regexp, { pattern: s, flags: o, value: l })
            );
          }),
            (oe.readInt = function(e, t) {
              for (
                var n = this.pos, r = 0, i = 0, s = null == t ? 1 / 0 : t;
                i < s;
                ++i
              ) {
              ...
              return this.pos === n || (null != t && this.pos - n !== t)
                ? null
                : r;
            }),
            ...
            (oe.readNumber = function(e) {
              ...
              46 !== s ||
                ...
                (69 !== s && 101 !== s) ||
                  i ||
                  ((43 !== (s = this.input.charCodeAt(++this.pos)) &&
                    45 !== s) ||
                    ++this.pos,
              ...
              return (
                r
                  ...
                  ? this.strict
                    ...
                    : (o = /[89]/.test(a) ? parseInt(a, 10) : parseInt(a, 8))
                  : (o = parseInt(a, 10)),
            ...
            (oe.readTmplToken = function() {
              for (var e = "", t = this.pos; ; ) {
                ...
                if (92 === n)
                  ...
                  switch (
                    ((e += this.input.slice(t, this.pos)), ++this.pos, n)
                  ) {
                    case 13:
      ...
      function(e, t, n) {
        !(function(e, r) {
          "object" == typeof n && void 0 !== t
            ...
            ? define(["exports"], r)
            : r(
                ((e.acorn = e.acorn || {}), (e.acorn.walk = e.acorn.walk || {}))
              );
        })(this, function(e) {
          "use strict";
          function t(e) {
          ...
          (o.Program = o.BlockStatement = function(e, t, n) {
            ...
            (o.SwitchStatement = function(e, t, n) {
              ...
              for (var r = 0, i = e.cases; r < i.length; r += 1) {
                ...
                for (var o = 0, a = s.consequent; o < a.length; o += 1) {
                  n(a[o], t, "Statement");
                }
              }
            }),
            ...
            (o.Class = function(e, t, n) {
              ...
              for (var r = 0, i = e.body.body; r < i.length; r += 1) {
                n(i[r], t);
              }
            }),
            ...
            (e.findNodeAround = function(n, r, s, o, a) {
              ...
              try {
                !(function e(t, n, a) {
                  var u = a || t.type;
                  if (!(t.start > r || t.end < r) && (o[u](t, n, e), s(u, t)))
                    throw new i(t, n);
                })(n, a);
              } catch (e) {
                if (e instanceof i) return e;
            ...
            (e.findNodeAfter = function(n, r, s, o, a) {
              ...
              try {
                !(function e(t, n, a) {
                  if (!(t.end < r)) {
                    var u = a || t.type;
                    if (t.start >= r && s(u, t)) throw new i(t, n);
                    o[u](t, n, e);
                  }
                })(n, a);
              } catch (e) {
      ...
      function(e, t, n) {
        ...
        function s(e, t, n) {
          for (var r, s = [], o = t; o < n; o += 3)
            (r = (e[o] << 16) + (e[o + 1] << 8) + e[o + 2]), s.push(i(r));
          return s.join("");
        }
        (n.byteLength = function(e) {
          ...
          (n.toByteArray = function(e) {
            var t,
              ...
              o,
              c = e.length;
            (s = r(e)), (o = new u((3 * c) / 4 - s)), (n = s > 0 ? c - 4 : c);
            var l = 0;
            for (t = 0; t < n; t += 4)
              (i =
                (a[e.charCodeAt(t)] << 18) |
          ...
          (n.fromByteArray = function(e) {
            for (
              var t, n = e.length, r = n % 3, i = "", a = [], u = 0, c = n - r;
              u < c;
              u += 16383
            )
    ...
    8: [
      function(e, t, n) {
        ...
        function u(e) {
          for (
            var t = e.length < 0 ? 0 : 0 | c(e.length), n = r(t), i = 0;
            i < t;
            i += 1
          )
            n[i] = 255 & e[i];
        ...
        function L(e) {
          return F.toByteArray(
            (function(e) {
              if ((e = e.trim().replace(I, "")).length < 2) return "";
              for (; e.length % 4 != 0; ) e += "=";
              return e;
            })(e)
          );
        ...
        (n.kMaxLength = B),
          ...
          (i.compare = function(e, t) {
            ...
            if (e === t) return 0;
            for (
              var n = e.length, r = t.length, s = 0, o = Math.min(n, r);
              s < o;
              ++s
            )
              if (e[s] !== t[s]) {
        ...
        (i.prototype.slice = function(e, t) {
          ...
          (i.prototype.readFloatLE = function(e, t) {
            return (
              (e >>>= 0), t || E(e, 4, this.length), $.read(this, e, !0, 23, 4)
            );
          }),
          (i.prototype.readFloatBE = function(e, t) {
            return (
              (e >>>= 0), t || E(e, 4, this.length), $.read(this, e, !1, 23, 4)
            );
          }),
          (i.prototype.readDoubleLE = function(e, t) {
            return (
              (e >>>= 0), t || E(e, 8, this.length), $.read(this, e, !0, 52, 8)
            );
          }),
          (i.prototype.readDoubleBE = function(e, t) {
            return (
              (e >>>= 0), t || E(e, 8, this.length), $.read(this, e, !1, 52, 8)
            );
          }),
          ...
          (i.prototype.copy = function(e, t, n, r) {
            ...
            else if (s < 1e3) for (i = 0; i < s; ++i) e[i + t] = this[i + n];
              ...
              t = Math.abs(t),
                isNaN(t) || t === 1 / 0
                  ...
                  : ((o = Math.floor(Math.log(t) / Math.LN2)),
                    ...
                    (t += o + p >= 1 ? h / u : h * Math.pow(2, 1 - p)) * u >=
                      2 && (o++, (u /= 2)),
                    o + p >= l
                      ? ((a = 0), (o = l))
                      : o + p >= 1
                      ? ((a = (t * u - 1) * Math.pow(2, i)), (o += p))
    ...
    10: [
      function(e, t, n) {
        (function(n) {
          ...
          function i(e) {
            (this.covers = {}),
              (this._ident = i.prototype.version + "_" + Math.random()),
              this.setOptions(e || {});
          }
          var s = e("./lib/parser"),
          ...
          (i.prototype.smCache = {}),
            (i.prototype.setOptions = function(e) {
              return (
                (this.log = !1 === e.log ? r : e.log || this.log),
            ...
            (i.prototype.compile = function(e, t, n, s) {
              "object" == typeof n && void 0 === s && (s = n), (s = s || {});
            ...
            (i.prototype.parse = function(e, t, n, r) {
              ...
              try {
                return (
                  (i.ast = s.parse(i.origCode, r && r.parser)),
                  r.babelTree &&
                    s.treeWalker(i.ast, function(e, t, n) {
                      "Literal" === e.type
                        ? n[0].replace(o.babelLiteralNode(e.value))
                        : "Property" === e.type &&
                          ("ClassBody" === n[0].parent.type
                ...
                if (e instanceof SyntaxError) {
                  var a = i.origCode.substr(e.pos - e.loc.column);
                  (a = a.split("\n")[0]),
                    (e.message +=
                      " " +
                      t +
                      ...
                      a +
                      "\n" +
                      a.replace(/[\S ]/g, "-").substring(0, e.loc.column) +
                      "^"),
                    (e.stack = "");
                }
                throw e;
            ...
            (i.prototype.prettyPrint = function(t, r) {
              var i = t.filename ? t.filename.split("/") : ["anonymous"],
                s = i.pop(),
                o = a(
                  t.ast,
                  r && r.sourcemap
              ...
              if (r && r.sourcemap)
                try {
                  var u = "",
                    c = o.map.toJSON();
                  if (c) {
                    var l = e("source-map").SourceMapConsumer;
                    (t.sourcemap = c),
                      (this.smCache[t.filename] = { map: c, smc: new l(c) }),
                      (u =
      ...
      function(e, t, n) {
        ...
        function u(e, t, n) {
          ...
          var i,
            s = {};
          if (Array.isArray(e)) {
            for (var o = 0; o < e.length; o++) if ((i = u(e[o], t))) return i;
            return null;
          }
          var c = n;
          "function" != typeof n &&
        ...
        function p(e) {
          ...
          if (!0 === e || !1 === e)
            return { type: "BooleanLiteral", value: e, raw: JSON.stringify(e) };
          ...
          return "number" == typeof e
            ? { type: "NumericLiteral", value: e, raw: JSON.stringify(e) }
            : { type: "StringLiteral", value: e, raw: JSON.stringify(e) };
        }
        function h(e, t) {
        ...
        function f(e) {
          var t = {};
          for (var n in e) t[n] = "string" == typeof e[n] ? h(e[n]) : e[n];
          return t;
        }
        function d(e, t, n, d) {
          function m(e, t) {
            if (n.es6target && !e.id && !t && 0 === e.type.indexOf("Function"))
            ...
            if (n.noRuntime) {
              if (t) {
                ...
                e.body.body = y.part("try {$:0} catch($2) {return $1($2)}", [
                  i(e.body),
                  t,
                  h("$boundEx")
                ]).body;
            ...
            return t
              ? y.part("$0.$1(this,$2)", [e, pe.asyncbind, t]).expr
          ...
          function b(e) {
            return n.babelTree
              ? p(e)
              : { type: "Literal", value: e, raw: JSON.stringify(e) };
          }
          function x(e) {
            return e
              ? !n.babelTree ||
                ("ClassMethod" !== e.type && "ObjectMethod" !== e.type)
                ? ((!n.babelTree && "MethodDefinition" === e.type) ||
                    ("Property" === e.type &&
            ...
            return (
              "$usesArguments" in e ||
                (y.treeWalker(e, function(t, r, i) {
                  "Identifier" === t.type && "arguments" === t.name
                    ? (i[0].parent.shorthand &&
                        ((i[0].parent.shorthand = !1),
                        (i[0].parent.key = h("arguments")),
                        (e.$usesArguments = !0)),
                      "key" !== i[0].field &&
                        ((t.name = n.$arguments), (e.$usesArguments = !0)))
                    : t !== e && a(t).isFunction
                    ? "ArrowFunctionExpression" === t.type &&
                      (w(t),
                      (e.$usesArguments = e.$usesArguments || t.$usesArguments))
                    : r();
                }),
                (e.$usesArguments = e.$usesArguments || !1)),
              e.$usesArguments && "ArrowFunctionExpression" !== e.type
            );
          }
          function E(e) {
            return (
              "string" != typeof e &&
                (e = e.type.replace(/Statement|Expression/g, "")),
              n.generatedSymbolPrefix + e + "_" + le++
            );
          }
          function S(e, t) {
            return (
              e && (e.$exit = f({ $error: t.$error, $return: t.$return })), e
            );
          }
          function k(e, t) {
            var n = (function(e) {
              for (var t = 0; t < e.length; t++) {
                ...
                if (e[t].parent && e[t].parent.$exit) return e[t].parent;
              }
              return null;
            })(e);
            if (n) return n.$exit;
            if (t) for (var r = 0; r < t.length; r++) if (t[r]) return f(t[r]);
            return null;
          }
          function A(e, t) {
            var r =
              !(n.promises || n.generators || n.engine) && n.lazyThenables;
            ie(e),
              ne(e),
              j(e),
              H(e),
                      ...
                      y.treeWalker(
                        ...
                        function(e, t, r) {
                          ...
                          function l(e, t) {
                            ...
                            else if ("ContinueStatement" === e.type)
                              s(
                                e,
                                i(
                                  o(
                            ...
                            else if (a(e).isFunction) return !0;
                            t();
                          }
                          "ForInStatement" === e.type && c(e)
                            ? U(e, r)
                            : "ForOfStatement" === e.type && c(e) && z(e, r),
                            t();
                          var p;
                          if (a(e).isLoop && c(e)) {
                            var f = e.init,
                              ...
                              v = e.body,
                              x = (function(e) {
                                return u(e, { type: "ThisExpression" });
                              })(v);
                            f &&
                              (a(f).isStatement ||
                                (f = {
                              ...
                              (v = a(v).isBlockStatement ? i(v).body : [i(v)]);
                            var w = e.$label && e.$label.name;
                            w = "Loop_" + (w || le++);
                            var E = n.generatedSymbolPrefix + (w + "_exit"),
                              S = n.generatedSymbolPrefix + (w + "_next"),
                              k = h(n.generatedSymbolPrefix + w),
                              A = function(e) {
                                return {
                                  type: "ReturnStatement",
                                  argument: {
                              ...
                              _ = C(S, [
                                {
                                  ...
                                  argument: {
                                    type: "CallExpression",
                                    callee: x ? m(k) : k,
                                    arguments: [h(E), pe.error]
                                  }
                                }
                              ]);
                            g && _.body.body.unshift(g);
                            ...
                            var T = {
                              ...
                              id: k,
                              params: [h(E), pe.error],
                              body: { type: "BlockStatement", body: [_] }
                            };
                            if ("DoWhileStatement" === e.type)
                              (_.body.body = [
                                ...
                                (T.body.body = [_].concat(v));
                            else {
                              var N = {
                                type: "IfStatement",
                                test: i(d),
                                consequent: { type: "BlockStatement", body: v },
                                alternate: i(A())
                              };
                              T.body.body.push(N);
                            }
                            ...
                            for (
                              !f ||
                                "VariableDeclaration" !== f.type ||
                                ("let" !== f.kind && "const" !== f.kind) ||
                                ("const" === f.kind && (f.kind = "let"),
                                (P = {
                                  type: "BlockStatement",
                                  body: [i(f), P]
                                }),
                              ...
                              if ("index" in F)
                                return (
                                  f
                                    ? F.parent[F.field].splice(
                                        F.index,
                                        1,
                                        i(f),
                                        P
                                      )
                                    : (F.parent[F.field][F.index] = P),
                                  !0
                                );
                            }
                          }
          ...
          function C(e, t) {
            var n = {
              $continuation: !0,
              type: e ? "FunctionDeclaration" : "FunctionExpression",
                  ...
                  function(e, t, n) {
                    if (
                      ...
                      "ConditionalExpression" === e.type &&
                        (c(e.alternate) || c(e.consequent)))
                    ) {
                      h(E("condOp"));
                      s(
                        e,
                        _(
                          y.part("if ($0) return $1 ; return $2", [
                            e.test,
                            e.consequent,
                            e.alternate
                          ]).body
          ...
          function F(e, t) {
            return Array.isArray(e)
              ...
              : (y.treeWalker(
                  e,
                  function(e, t, n) {
                    if ((t(), "LogicalExpression" === e.type && c(e.right))) {
                      var r,
                        i = h(
                          E("logical" + ("&&" === e.operator ? "And" : "Or"))
                        );
                      if ("||" === e.operator)
                        r = "var $0; if (!($0 = $1)) {$0 = $2} return $0";
                      else {
                        if ("&&" !== e.operator)
                          throw new Error(
                            v(e) + "Illegal logical operator: " + e.operator
                          );
                        r = "var $0; if ($0 = $1) {$0 = $2} return $0";
                      }
                      s(e, _(y.part(r, [i, e.left, e.right]).body));
                    }
                  },
                  t
                ),
          ...
          function $(e, t, n) {
            if ("SwitchCase" !== e.type && a(e).isBlockStatement)
              for (var r = 0; r < e.body.length; ) {
                var i = e.body[r];
                if ("SwitchCase" !== i.type && a(i).isBlockStatement) {
                  if (ae(i.body))
                    if (l(i)) {
                      var s = E(i),
                        o = e.body.splice(r + 1, e.body.length - (r + 1));
                      if (o.length) {
                        var u = C(s, o);
                        delete ce[s], i.body.push(O(s)), e.body.push(u), r++;
                      } else r++;
                    } else r++;
                  else e.body.splice.apply(e.body, [r, 1].concat(i.body));
                } else r++;
              }
          }
          function B(e, t, n) {
            if ("IfStatement" === e.type && c([e.consequent, e.alternate])) {
              var r = E(e),
                o = t[0],
              ...
              if ("index" in o) {
                ...
                if ((o.replace(u), p.length)) {
                  var h = O(r);
                  u.body.push(n(C(r, p))),
                    [e.consequent, e.alternate].forEach(function(e) {
                      if (e) {
                        var t;
                        ((t = a(e).isBlockStatement
                          ? e.body[e.body.length - 1]
                          : e) &&
                          "ReturnStatement" === t.type) ||
                          ("BlockStatement" !== e.type &&
                            s(e, { type: "BlockStatement", body: [i(e)] }),
                          (e.$deferred = !0),
                          e.body.push(i(h))),
                          n(e);
                      }
          ...
          function R(e, t, n) {
            if (!e.$switched && "SwitchStatement" === e.type && c(e.cases)) {
              e.$switched = !0;
              var r,
                s,
                o,
              ...
              if ("index" in a) {
                var u = a.index + 1;
                (o = a.parent[a.field].splice(u, a.parent[a.field].length - u))
                  .length &&
              ...
              return (
                e.cases.forEach(function(e, t) {
                  if ("SwitchCase" !== e.type)
                    throw new Error(
                      "switch contains non-case/default statement: " + e.type
                    );
                  if (c(e.consequent)) {
                    var n = e.consequent[e.consequent.length - 1];
                    "BreakStatement" === n.type
                      ? (e.consequent[e.consequent.length - 1] = i(s))
          ...
          function I(e) {
            return "ReturnStatement" === e.type || "ThrowStatement" === e.type;
          }
          function j(t, r) {
            return (
                ...
                if (
                    ...
                    (function(e) {
                      for (var t = 0; t < e.length; t++)
                        if (a(e[t].self).isFunction)
                          return e[t].self.async || e[t].self.$wasAsync;
                      return !1;
                    })(s) &&
                  ...
                  if (t.finalizer && !t.handler) {
                    ...
                    t.handler = {
                      ...
                      body: {
                        type: "BlockStatement",
                        body: [{ type: "ThrowStatement", argument: l }]
                      }
                    };
                  }
                  if (!t.handler && !t.finalizer) {
                    var p = new SyntaxError(
                      v(t.value) + "try requires catch and/or finally clause",
                      e.filename,
                      t.start
                    );
                    throw ((p.pos = t.start), (p.loc = t.loc.start), p);
                  }
                  t.finalizer
                    ? (S(t.block, {
                        $error: t.$seh + "Catch",
          ...
          function M(t, r, s) {
            if (t.$needsMapping) {
              var o,
                ...
                c = r[0];
              if (!("index" in c))
                throw new Error(e.filename + " - malformed try/catch blocks");
              var l = c.index + 1,
                p = c.parent[c.field].splice(l, c.parent[c.field].length - l);
              if (p.length) {
                var f = s(g((a = t.$seh + "Post"), p, [], k(r, [n]).$error));
                c.parent[c.field].splice(c.index, 0, f),
                  (o = y.part("return $0()", [t.finalizer ? T(t, h(a)) : h(a)])
                    .body[0]);
              } else t.finalizer && (o = O(T(t)));
              (t.$mapped = !0),
                o && (t.block.body.push(i(o)), t.handler.body.body.push(i(o)));
              var d = k(r, [n]);
              if (t.handler) {
                var v = h(t.$seh + "Catch");
                u = i(t.handler.body);
              ...
              if (t.finalizer) {
                ...
                var S = y.part("return $0()", [t.finalizer ? T(t, h(a)) : h(a)])
                  .body[0];
                (u.body[u.length - 1] = S),
                ...
                if (
                  ...
                  if (
                    !(t =
                      t ||
                      l.some(function(e) {
                        return e.self && e.self.$wasAsync;
                      })) ||
                    "warn" === t
                  ) {
                    var f = v(e) + "'await' used inside non-async function. ";
                    n.promises
                      ? (f += "'return' value Promise runtime-specific")
                      : (f += "'return' value from await is synchronous"),
                      d(
                        f +
                  ...
                  for (var x, w, S = 1; S < l.length; S++)
                    if ((w = a(l[S].self).isBlockStatement)) {
                      x = l[S - 1];
                      break;
                    }
                  if (!x)
                    throw new Error(
                      v(e) + "Illegal await not contained in a statement"
                    );
                  var A,
                    C,
                    _ = k(l, [o, n]),
                  ...
                  x.self.argument.arguments[0].name === g.name
                    ...
                    : "Identifier" === x.self.type ||
                      x.self.name === g.name ||
                      ("ExpressionStatement" === x.self.type &&
                        "Identifier" === x.self.expression.type &&
                    ...
                    : (O.unshift(x.self),
                      (A = {
                        type: "FunctionExpression",
                        params: [i(g)],
                        body: q({ type: "BlockStatement", body: i(O) }, t, _)
                      })),
                    C ||
                      (C = A
                        ? m(A, _.$error)
                  ...
                  w.push({ loc: p, type: "ReturnStatement", argument: T });
                }
                return !0;
              }),
              e
          ...
          function U(e, t) {
            ...
            var r = h(E("idx")),
              i = h(E("in")),
              o = y.part("var $0,$1 = [];for ($0 in $2) $1.push($0)", [
                r,
                i,
                e.right
              ]).body,
              u = y.part("for ($0; $1.length;){ $2 = $1.shift(); $:3 ; }", [
                e.left,
                i,
            ...
            for (var c = 0; c < t.length; c++)
              if (a(t[c].parent).isBlockStatement) {
                t[c].parent[t[c].field].splice(t[c].index, 0, o[0], o[1]);
                break;
              }
            s(e, u);
          }
          function z(e, t) {
            ...
            var n,
              r,
              i = y.part("[$0[Symbol.iterator]()]", [e.right]).expr;
            if ("VariableDeclaration" === e.left.type) {
              ...
              (r = h(E("iterator_" + s.join("_")))),
                (e.left.declarations = s.map(function(e) {
                  return { type: "VariableDeclarator", id: h(e) };
                })),
              ...
              var o = {
                ...
                declarations: [
                  {
                    type: "VariableDeclarator",
                    id: (r = h(E("iterator_" + (n = e.left).name))),
                    init: i
                  }
                ]
              };
          ...
          function W(e, t, r) {
            ...
            if (
              ...
              u(e, function(e) {
                return (
                  ("AwaitExpression" === e.type && !e.$hidden) ||
                  (s &&
              ...
              var o = [],
                ...
                f = e.update,
                d = e.body;
              f && (f = { type: "ExpressionStatement", expression: f }),
                l &&
                  (a(l).isStatement ||
                    (l = { type: "ExpressionStatement", expression: l }),
                  o.push(l));
              var m, g;
              e.$label
              ...
              var v,
                x,
                w = h(
                  (g = n.generatedSymbolPrefix + "Loop_" + g) + "_trampoline"
                ),
                E = h(g),
                S = f ? h(g + "_step") : E,
                A = h(g + "_exit");
              ...
              var L = { type: "ReturnStatement", argument: E },
                ...
                T = {
                  type: "ReturnStatement",
                  argument: { type: "ArrayExpression", elements: [b(1)] }
                };
              y.treeWalker(
                d,
                function(e, t, n) {
                  if (a(e).isFunction || a(e).isLoop) return !0;
                  if (
                    "BreakStatement" === e.type ||
                    "ContinueStatement" === e.type
                  )
                    if (e.label)
                      for (
                        var r = n
                            .filter(function(e) {
                              return ("$label" in e.self);
                            })
                            .map(function(e, t) {
                              return e.self.$label && e.self.$label.name;
                            }),
                          i = [],
                          s = 0;
                        s < r.length;
                        ...
                        if (r[s] === e.label.name) {
                          "BreakStatement" === e.type && i.push(b(1)),
                            n[0].replace({
                              type: "ReturnStatement",
                              argument: {
                ...
                (d = "BlockStatement" === d.type ? d.body.slice(0) : [d]),
                (d =
                ...
                n.noRuntime &&
                  o.push({
                    type: "VariableDeclaration",
                    declarations: [{ type: "VariableDeclarator", id: w }],
                    kind: "var"
                  });
              var N,
                P = k(t, [n]).$error;
              (N = n.noRuntime
                ...
                : y.part("(Function.$0.trampoline(this,$1,$2,$3,$5)($4))", [
                    pe.asyncbind,
                    A,
                    S,
                    P,
                ...
                f &&
                  o.push({
                    ...
                    id: S,
                    params: [],
                    body: { type: "BlockStatement", body: [f, L] }
                  }),
                !l ||
                ...
                ("let" !== l.kind && "const" !== l.kind)
                  ...
                  : ("const" === l.kind && (l.kind = "let"),
                    t[0].replace([
                      { type: "BlockStatement", body: o.map(r) },
                      r(v)
                    ]));
            }
          }
          function G(e) {
            ...
            return u(
              ...
              function(e) {
                return (
                  ("Identifier" === e.type &&
                    (e.name === n.$return || e.name === n.$error)) ||
                  (I(e) && a(e).isAsync)
                );
              },
              function(e) {
                return !(a(e).isFunction && (e.$wasAsync || a(e).isAsync));
              }
            );
          }
          function J(t) {
              ...
              if ((r(), s && a(s).isAsync)) {
                if ("set" == t.kind) {
                  var o = new SyntaxError(
                    v(s) + "method 'async set' cannot be invoked",
                    e.filename,
                    t.start
                  );
                  throw ((o.pos = t.start), (o.loc = t.loc.start), o);
                }
                s.async = !1;
                var u = w(s);
                G(s) ||
                  (0 !== s.body.body.length &&
                    "ReturnStatement" ===
                      s.body.body[s.body.body.length - 1].type) ||
                ...
                n.promises
                  ...
                  : (s.body = {
                      type: "BlockStatement",
                      body: [{ type: "ReturnStatement", argument: c }]
                    }),
                  u && D(s.body.body, [he]);
              }
            });
                ...
                if ((t(), a(e).isAsync && a(e).isFunction)) {
                  ...
                  return (
                    a(e.body).isBlockStatement
                      ? (G(e) ||
                          (0 !== e.body.body.length &&
                            "ReturnStatement" ===
                              e.body.body[e.body.body.length - 1].type) ||
                          e.body.body.push({ type: "ReturnStatement" }),
                        (o.body = {
                          type: "BlockStatement",
                          body: e.body.body.map(function(e) {
                            return N(e, u);
                          })
                        }))
                      : ((o.body = {
                          type: "BlockStatement",
                          body: [
                            N({ type: "ReturnStatement", argument: e.body }, u)
                          ]
                        }),
                        (e.expression = !1)),
                    (o = m(
                    ...
                    (o = {
                      type: "BlockStatement",
                      body: [
                        { type: "ReturnStatement", loc: e.loc, argument: o }
                      ]
                    }),
                    s && D(o.body, [he]),
                    void (e.body = o)
          ...
          function Y(e) {
            ...
            return y.treeWalker(e, function(e, n, r) {
              if (
                ("ThrowStatement" !== e.type && "ReturnStatement" !== e.type) ||
                e.$mapped
              ) {
          ...
          function Q(e, t) {
            ...
            return y.part(
              "{ return (function*($return,$error){ $:body }).$asyncspawn(Promise,this) }",
              {
                ...
                body: Y(e).concat(
                  t ? [{ type: "ReturnStatement", argument: pe.return }] : []
                )
              }
            ).body[0];
          }
            ...
            function u(e) {
              return (
                "BlockStatement" !== e.body.type &&
                  (e.body = {
                    type: "BlockStatement",
                    body: [{ type: "ReturnStatement", argument: e.body }]
                  }),
                e
              );
            }
              ...
              if (a(e).isAsync && a(e).isFunction) {
                ...
                (f = x(i[0].parent)) &&
                  ...
                  (p = G(e))
                    ? (c(p, e.body), o(e))
                    : t
                    ? "get" !== i[0].parent.kind && r(e, !0)
                    : (delete (l = e).async,
                      (h = w(l)),
                      r(l, !1),
                      ((l = u(l)).body = Q(l.body.body, p)),
                      h && D(l.body.body, [he]),
                      l.id && "ExpressionStatement" === i[0].parent.type
                        ? ((l.type = "FunctionDeclaration"), i[1].replace(l))
                        : i[0].replace(l));
          ...
          function K(e, t, n) {
            ...
            return (
              y.treeWalker(e, function(i, s, o) {
                if (i === e) return s();
                t(i, o) ? r.push([].concat(o)) : n || a(i).isScope || s();
              }),
              r
            );
          }
          function ee(e, t) {
            ...
            if (
              (e = e.filter(function(e) {
                return "ExportNamedDeclaration" !== e[0].parent.type;
              })).length
            ) {
              var s = {};
              e.forEach(function(e) {
                ...
                for (
                  var n = e[0], o = n.self, a = (o.kind, []), u = 0;
                ...
                if (0 == a.length) n.remove();
                  ...
                  "For" !== n.parent.type.slice(0, 3) &&
                    (p = { type: "ExpressionStatement", expression: p }),
                    n.replace(p);
                }
              });
              var o = Object.keys(s);
              o.length &&
                ...
                n[0] && "VariableDeclaration" === n[0].type
                  ? (n[0].declarations = n[0].declarations.concat(o))
                  : n.unshift({
                      type: "VariableDeclaration",
                      kind: t,
                      declarations: o
            ...
            function n(e) {
              return function(t, n) {
                if (
                  ...
                  return (
                    ("left" != r.field ||
                      ("ForInStatement" !== r.parent.type &&
                        "ForOfStatement" !== r.parent.type)) &&
                    ("init" != r.field ||
                      "ForStatement" !== r.parent.type ||
                      ("const" !== t.kind && "let" !== t.kind))
                  );
                }
              };
            }
            ...
            y.treeWalker(e, function(e, n, r) {
              ...
              if ((n(), e.type in l && !e.$hoisted)) {
                ...
                for (u = 0; u < p.length; u++)
                  if (!a(p[u]).isScope) {
                    if (((r = c(p[u])) && o(r[0].self), !c(p.slice(u + 1))))
                      break;
                ...
                for (u = e.declarations.length - 1; u > 0; u--)
                  if (
                    ...
                    var f = {
                        type: "VariableDeclaration",
                        kind: e.kind,
                        declarations: e.declarations.splice(u)
                      },
                      d = r[0];
                    if (!("index" in d))
                      throw new Error("VariableDeclaration not in a block");
                    d.parent[d.field].splice(d.index + 1, 0, f);
                  }
            }),
              (function(e) {
                function t(e) {
                  d(v(e) + "Possible assignment to 'const " + r(e) + "'");
                }
                function n(e) {
                  switch (e.type) {
                    case "Identifier":
                ...
                y.treeWalker(e, function(e, t, r) {
                  ...
                  if (s) {
                    ...
                    for (var o = 0; o < s.length; o++)
                      if ("VariableDeclaration" === s[o].type)
                        for (var u = 0; u < s[o].declarations.length; u++)
                          te(s[o].declarations[u].id).forEach(function(e) {
                            i[e] = s[o].kind;
                          });
                  }
                  t(),
                    "AssignmentExpression" === e.type
                      ? n(e.left)
                      : "UpdateExpression" === e.type && n(e.argument),
            ...
            return (
              y.treeWalker(e, function(e, t, i) {
                ...
                if (((p = p || oe(e)), a(e).isBlockStatement)) {
                  if (c(e)) {
                    var l, f, y, m, g;
                    if (!i[0].parent || a(i[0].parent).isScope) {
                      var x = {},
                        w = {};
                      (f = K(e, n(["const"]), !1)).forEach(function(e) {
                        e[0].self.declarations.forEach(function(e) {
                          te(e.id).forEach(function(t) {
                            x[t] || w[t]
                              ? (delete x[t], (w[t] = e))
                              : (x[t] = e);
                          });
                        ...
                        f.forEach(function(e) {
                          for (
                            var t = 0;
                            t < e.length && !a(e[t].parent).isBlockStatement;
                            t++
                          );
                          var n = e[t];
                          n.append({
                            ...
                            expression: {
                              type: "SequenceExpression",
                              expressions: e[0].self.declarations.map(function(
                                e
                              ) {
                                var t = {
                                  type: "AssignmentExpression",
                                ...
                                return (e.init = null), t;
                              })
                            }
                          });
                          var r = te(e[0].self.declarations),
                          ...
                          i.length &&
                            ...
                            (i = r.filter(function(e) {
                              ...
                              ? (e[0].self.declarations = i.map(function(e) {
                                  return {
                                    type: "VariableDeclarator",
                                    id: h(e)
                                  };
                    ...
                    (m = m.concat(K(e, n(["let"]), !0))),
                      ...
                      (g = K(e, o, p)),
                      (y = y ? ee(y, "var") : { duplicates: {}, decls: [] }),
                      (m = m ? ee(m, "let") : { duplicates: {}, decls: [] }),
                      Object.keys(y.duplicates).forEach(function(e) {
                        d(
                          v(y.duplicates[e]) +
                      ...
                      Object.keys(m.duplicates).forEach(function(e) {
                        d(
                          v(m.duplicates[e]) +
                            "Duplicate declaration '" +
                            r(m.duplicates[e]) +
                      ...
                      (g = g.map(function(e) {
                        ...
                        if (a(n.self).isAsync)
                          return (
                            (t = n.self.id.name),
                            a(n.parent).isBlockStatement
                              ? ((n.self.type = "FunctionDeclaration"),
                                n.remove(),
                                n.self)
                              : n.replace(h(t))
                          );
                        t = n.self.id.name;
                        return "FunctionDeclaration" === n.self.type
                          ? n.remove()
                          : n.replace(h(t));
                      })),
                      ((l = l.map(function(e) {
                ...
                if (
                  ("LabeledStatement" === e.type &&
                    ...
                    c(e.body) &&
                    u(e.body, function(e) {
                      return "BreakStatement" === e.type && e.label;
                    }) &&
                    (e.body.body.push({ type: "BreakStatement" }),
                    (e.body = {
                  ...
                  for (var E = 0, S = 0; S < i.length; S++)
                    if (
                      "ForOfStatement" === i[S].self.type ||
                      "ForInStatement" === i[S].self.type ||
                      a(i[S].self).isLoop
                    )
                      E += 1;
              ...
              if (
                ...
                ("ClassDeclaration" === e.type ||
                  ...
                  (e.body.body.forEach(
                    (function(e, t) {
                      function n() {
                        return (e.$superID = e.$superID || h("$super$" + le++));
                      }
                      return function(e) {
                        (e = x(e)) &&
                          a(e).isAsync &&
                          ...
                          y.treeWalker(e.body, function(e, t, r) {
                            var i;
                            a(e).isClass ||
                              (t(),
                              "Super" === e.type &&
                                ("MemberExpression" === r[0].parent.type
                                  ? "CallExpression" === r[1].parent.type &&
                                    "callee" === r[1].field
                                    ? ((i = y.part(
                                        "this.$super($field).call(this,$args)",
                                        {
                                          super: n(),
                                          field: r[0].parent.computed
                                            ? r[0].parent.property
                                            : b(r[0].parent.property.name),
                                          args: r[1].parent.arguments
                                        }
                                      ).expr),
                                      r[2].replace(i))
                                    : ((i = y.part("this.$super($field)", {
                                        super: n(),
                                        field: r[0].parent.computed
                                          ? r[0].parent.property
                                          : b(r[0].parent.property.name)
                ...
                var s = y.part("(function($field) { return super[$field] })", {
                  field: h("$field")
                }).expr;
                n.babelTree
                  ? ((s.type = "ClassMethod"),
          ...
          function oe(e) {
            if ("Program" === e.type && "module" === e.sourceType) return !0;
            var t;
            ...
            if (t)
              for (var n = 0; n < t.length; n++)
                if (
                  a(t[n]).isDirective &&
                  t[n].expression.value.match(/^\s*use\s+strict\s*$/)
                )
                  return !0;
            return !1;
          }
          ...
          function ue(e) {
                ...
                if ((r = a(e).isBlockStatement))
                  for (var s = 0; s < r.length; s++)
                    (i = a(r[s]).isBlockStatement) &&
                      !ae(i) &&
                      (ae(r[s]) || [].splice.apply(r, [s, 1].concat(i)));
              }
            }),
              y.treeWalker(e, function(e, t, n) {
                if ((t(), a(e).isJump)) {
                  ...
                  if ("index" in r)
                    for (
                      var i = r.index + 1, s = r.parent[r.field];
                      i < s.length;

                    )
                      "VariableDeclaration" === s[i].type ||
            ...
            if (t.length) {
              y.treeWalker(e, function(e, n, r) {
                if (
                  (n(),
                  t.indexOf(e) >= 0 && "ReturnStatement" === r[1].self.type)
                ) {
                  var s = e.$thisCallName,
                    o = i(ce[s].def.body.body);
                  (ce[s].$inlined = !0),
                    a(r[1].self).isJump || o.push({ type: "ReturnStatement" }),
                    r[1].replace(o);
                }
              });
            ...
            if (
              !(
                ("Program" === e.type && "module" === e.sourceType) ||
                u(
                  e,
                  function(e) {
                    return a(e).isES6;
          ...
          var he = y.part("var $0 = arguments", [pe.arguments]).body[0];
          return (
            n.engine
              ? ((e.ast = re(e.ast, !0)),
          ...
          v = {
            ...
            isBlockStatement: function() {
              return "ClassBody" === this.node.type ||
                ...
                ? this.node.body
                : "SwitchCase" === this.node.type && this.node.consequent;
            },
            ...
            isDirective: function() {
              return (
                ...
                ("StringLiteral" === this.node.expression.type ||
                  ("Literal" === this.node.expression.type &&
                    "string" == typeof this.node.expression.value))
              );
            },
            ...
            isAwait: function() {
              return "AwaitExpression" === this.node.type && !this.node.$hidden;
            },
            isAsync: function() {
            ...
            isStatement: function() {
              return (
                null !== this.node.type.match(/[a-zA-Z]+Declaration/) ||
                null !== this.node.type.match(/[a-zA-Z]+Statement/)
              );
            },
            isExpression: function() {
              return null !== this.node.type.match(/[a-zA-Z]+Expression/);
            },
            isLoop: function() {
              return (
            ...
            isES6: function() {
              switch (this.node.type) {
                ...
                case "VariableDeclaration":
                  return this.node.kind && "var" !== this.node.kind;
            ...
            asynchronize: function(e, t, n, r) {
              try {
                ...
                if (t instanceof SyntaxError) {
                  var i = e.origCode.substr(t.pos - t.loc.column);
                  (i = i.split("\n")[0]),
                    (t.message +=
                      " (nodent)\n" +
                      i +
                      "\n" +
                      i.replace(/[\S ]/g, "-").substring(0, t.loc.column) +
                      "^"),
                    (t.stack = "");
                }
                throw t;
    ...
    12: [
      function(e, t, n) {
        "use strict";
        function r(e) {
          if ("NewExpression" === e.type && e.arguments && e.arguments.length)
            return 19;
          var t =
            h[e.type] ||
            h[e.type + e.operator] ||
          ...
          d = {
            out: function(e, t, n) {
              ...
              r
                ...
                : t.write(
                    e,
                    "/*" + e.type + "?*/ " + t.sourceAt(e.start, e.end)
                  );
            },
            expr: function(e, t, n, i) {
              2 === i || r(n) < r(t) || (r(n) == r(t) && (i || t.right === n))
                ? (e.write(null, "("),
                  this.out(n, e, n.type),
                  e.write(null, ")"))
                : this.out(n, e, n.type);
            ...
            argumentList: function(e, t) {
              ...
              if (n.length > 0)
                for (var r = n.length, i = 0; i < r; i++)
                  0 != i && t.write(null, ", "), this.expr(t, f, n[i]);
              t.write(null, ")");
            },
            formatParameters: function(e, t) {
              var n;
              if ((t.write(null, "("), null != e && e.length > 0)) {
                this.out(e[0], t, e[0].type);
                for (var r = 1, i = e.length; r < i; r++)
                  (n = e[r]), t.write(n, ", "), this.out(n, t, n.type);
              }
              t.write(null, ") ");
            },
            ...
            BlockStatement: (u = function(e, t) {
              var n,
                ...
                s = t.lineEnd,
                o = i + t.indent;
              if ((t.write(e, "{"), null != (n = e.body) && n.length > 0)) {
                t.write(null, s);
              ...
              t.write(
                e.loc
                  ? { loc: { start: { line: e.loc.end.line, column: 0 } } }
                  : null,
                "}"
              ),
                t.indentLevel--;
            ...
            IfStatement: function(e, t) {
              t.write(e, "if ("),
                ...
                t.write(null, ") "),
                "BlockStatement" !== e.consequent.type &&
                  t.write(null, t.lineEnd, c(t.indent, t.indentLevel + 1)),
                this.out(e.consequent, t, e.consequent.type),
                null != e.alternate &&
                  ("BlockStatement" !== e.consequent.type &&
                    t.write(null, t.lineEnd, c(t.indent, t.indentLevel)),
                  t.write(null, " else "),
                  "BlockStatement" !== e.alternate.type &&
            ...
            BreakStatement: function(e, t) {
              t.write(e, "break"),
                e.label &&
                  (t.write(null, " "), this.out(e.label, t, e.label.type)),
                t.write(null, ";");
            },
            ...
            SwitchStatement: function(e, t) {
              ...
              var a = s + t.indent,
                u = a + t.indent;
              t.write(e, "switch ("),
                this.out(e.discriminant, t, e.discriminant.type),
                t.write(null, ") {", o);
            ...
            TryStatement: function(e, t) {
              t.write(e, "try "),
                ...
                e.handler && this.out(e.handler, t, e.handler.type),
                e.finalizer &&
            ...
            ForStatement: function(e, t) {
              if ((t.write(e, "for ("), null != e.init)) {
                ...
                t.inForInit++,
                  this.out(n, t, r),
                  t.inForInit--,
                  "VariableDeclaration" !== r && t.write(null, "; ");
              } else t.write(null, "; ");
              e.test && this.out(e.test, t, e.test.type),
                t.write(null, "; "),
                e.update && this.out(e.update, t, e.update.type),
                t.write(null, ") "),
                "BlockStatement" !== e.body.type &&
                  t.write(null, t.lineEnd, c(t.indent, t.indentLevel + 1)),
                this.out(e.body, t, e.body.type);
            ...
            Function: function(e, t) {
              e.async && t.write(e, "async "),
                t.write(e, e.generator ? "function* " : "function "),
            ...
            VariableDeclaration: function(e, t) {
              ...
              if (r > 0) {
                ...
                for (var i = 1; i < r; i++)
                  t.write(null, ", "), this.out(n[i], t, "VariableDeclarator");
              }
              t.write(null, ";");
            },
            VariableDeclarator: function(e, t) {
              this.out(e.id, t, e.id.type),
                null != e.init &&
                  (t.write(null, " = "), this.expr(t, f, e.init));
            },
            ClassDeclaration: function(e, t) {
              t.write(e, "class "),
                ...
                e.superClass &&
                  ...
                  this.out(e.superClass, t, e.superClass.type),
                  t.write(null, " ")),
            ...
            ImportNamespaceSpecifier: function(e, t) {
              t.write(null, "* as "), this.out(e.local, t, e.local.type);
            },
              ...
              if (r > 0) {
                for (var s = 0; s < r; s++)
                  "ImportSpecifier" === n[s].type &&
                    ...
                    s < r - 1 && t.write(null, ", ");
                "ImportSpecifier" === n[r - 1].type && t.write(null, "}"),
                  t.write(null, " from ");
              }
                ...
                if ((t.write(e, "{"), n && n.length > 0))
                  for (var r = 0; r < n.length; r++)
                    this.out(n[r], t, n[r].type),
                      r < n.length - 1 && t.write(null, ", ");
                t.write(null, "}"),
                  e.source && t.write(e.source, " from ", e.source.raw),
                  t.write(null, ";");
              }
            },
            ...
            ArrowFunctionExpression: function(e, t) {
              e.async && t.write(e, "async "),
                1 === e.params.length && "Identifier" === e.params[0].type
                  ? (this.out(e.params[0], t, e.params[0].type),
                    t.write(e, " => "))
                  : (this.formatParameters(e.params, t), t.write(e, "=> ")),
            ...
            RestElement: (s = function(e, t) {
              t.write(e, "..."), this.out(e.argument, t, e.argument.type);
            }),
            SpreadElement: s,
            YieldExpression: function(e, t) {
              t.write(e, e.delegate ? "yield*" : "yield"),
                e.argument && (t.write(null, " "), this.expr(t, e, e.argument));
            },
            ...
            TemplateLiteral: function(e, t) {
              ...
              for (var s = 0, o = i.length; s < o; s++)
                (n = i[s]),
                  ...
                  this.out(n, t, n.type),
                  t.write(null, "}");
              t.write(r[r.length - 1].value, r[r.length - 1].value.raw),
                t.write(e, "`");
            },
            ...
            ArrayExpression: (a = function(e, t) {
              if ((t.write(e, "["), e.elements.length > 0))
                for (var n = e.elements, r = n.length, i = 0; ; ) {
                  var s = n[i];
                  if (
                    (s && this.expr(t, f, s),
                    ((i += 1) < r || null === s) && t.write(null, ","),
                    i >= r)
                  )
                    break;
            ...
            SequenceExpression: function(e, t) {
              ...
              if (r.length > 0)
                for (var i = r.length, s = 0; s < i; s++)
                  (n = r[s]), s && t.write(null, ", "), this.expr(t, f, n);
            },
            UnaryExpression: function(e, t) {
              e.prefix
                ...
                : (this.expr(t, e, e.argument), t.write(e, e.operator));
            },
            ...
            BinaryExpression: (o = function(e, t) {
              ...
              "in" === n && t.inForInit && t.write(null, "("),
                ...
                this.expr(
                  ...
                  e,
                  e.right,
                  "ArrowFunctionExpression" === e.right.type ? 2 : 0
                ),
                "in" === n && t.inForInit && t.write(null, ")");
            }),
            LogicalExpression: o,
            AssignmentExpression: function(e, t) {
              "ObjectPattern" === e.left.type && t.write(null, "("),
              ...
              ("ArrayExpression" === e.object.type ||
                ...
                e.computed
                  ? (t.write(e, "["),
                    ...
                    t.write(null, "]"))
                  : (t.write(e, "."), this.out(e.property, t, e.property.type));
            },
            ...
            RegExpLiteral: function(e, t) {
              t.write(e, e.extra.raw || "/" + e.pattern + "/" + e.flags);
            },
                  ...
                  if (
                    (s &&
                      ...
                      s.addMapping({
                        ...
                        generated: {
                          line: t.map.startLine + i.length + 1,
                          column: r.length
                        }
                      }),
                    ...
                    (r += arguments[n]),
                      e &&
                        e.$comments &&
                        (e.$comments.forEach(function(t) {
                          var n = e.loc.start.column < t.loc.start.column;
                          (t.indent = p.indentLevel), n ? u.push(t) : a.push(t);
                        }),
                        (e.$comments = null));
              },
              back: function() {
    ...
    13: [
      function(e, t, n) {
              ...
              function() {
                e.type in a &&
                  a[e.type](e, n, function t(i, s, o) {
                    if (i === e) return a[o || e.type](e, n, t);
                    for (var u = Object.keys(e), c = 0; c < u.length; c++) {
                      var l = e[u[c]];
                      Array.isArray(l)
                        ? l.indexOf(i) >= 0 &&
                          r({ self: i, parent: e, field: u[c], index: !0 })
                        : l instanceof Object &&
                          i === l &&
                          r({ self: i, parent: e, field: u[c] });
                    }
                  });
              },
              n
        ...
        function s(t, n) {
          ...
          if (
            ((!n || !n.noNodentExtensions || parseInt(o.version) < 4) &&
              (c ||
                ...
                (c = !0)),
              (s.plugins = s.plugins || {}),
              (s.plugins.asyncawait = { asyncExits: !0, awaitAnywhere: !0 })),
            n)
          )
            for (var a in n) "noNodentExtensions" !== a && (s[a] = n[a]);
          var u = o.parse(t, s);
          return (
            i(u, function(e, t, n) {
              for (
                ...
                (e.$comments = e.$comments || []), e.$comments.push(r.shift());
            }),
            u
          );
        }
        var o = e("acorn"),
          a = e("acorn/dist/walk").make({
            ...
            SwitchStatement: function(e, t, n) {
              n(e.discriminant, t, "Expression");
              for (var r = 0; r < e.cases.length; ++r) n(e.cases[r], t);
            },
            ...
            ClassBody: function(e, t, n) {
              for (var r = 0; r < e.body.length; r++) n(e.body[r], t);
            },
            ...
            ClassMethod: function(e, t, n) {
              e.key && n(e.key, t, "Expression"), n(e, t, "Function");
            },
          ...
          u = {
            replace: function(e) {
              return (
                ...
                "index" in this
                  ? (r(this.parent[this.field][this.index], e),
                    Array.isArray(e)
                      ? [].splice.apply(
                          this.parent[this.field],
                          [this.index, 1].concat(e)
                        )
                      : (this.parent[this.field][this.index] = e))
            ...
            append: function(e) {
              ...
              return (
                Array.isArray(e)
                  ...
                  : this.parent[this.field].splice(this.index + 1, 0, e),
                this.self
              );
            },
            index: function() {
            ...
            function n(e, r) {
              ...
              return (
                ...
                Object.keys(e).forEach(function(i) {
                  if (!(e[i] instanceof Object)) return (r[i] = e[i]);
                  if (Array.isArray(e[i])) return (r[i] = n(e[i], []));
                  var s;
                  if (
                    ((s = Array.isArray(r)
                      ? function(e) {
                      ...
                      : function(e) {
                          return (
                            "function" == typeof e && (e = e()), (r[i] = e), r
                          );
                        }),
                    "Identifier" === e[i].type && "$" === e[i].name[0])
                  )
                  ...
                  return "LabeledStatement" === e[i].type &&
                    ...
                    ? s(t[e[i].label.name.slice(2)](n(e[i]).body))
                    : s(n(e[i]));
                }),
                r
              );
      ...
      function(e, t, n) {
        ...
        (r.fromSourceMap = function(e) {
          ...
          (r.prototype.allGeneratedPositionsFor = function(e) {
            ...
            if (
              (null != this.sourceRoot &&
                (n.source = a.relative(this.sourceRoot, n.source)),
            ...
            for (
              ...
              if (";" === e.charAt(v)) c++, v++, (h = 0);
                ...
                for (
                  ...
                  o < g && !this._charIsMappingSeparator(e, o);
                  o++
                );
                if (((r = e.slice(v, o)), (i = b[r]))) v += r.length;
                else {
                  for (i = []; v < o; )
                    l.decode(e, v, x), (u = x.value), (v = x.rest), i.push(u);
                  if (2 === i.length)
            ...
            if (n >= 0) {
              ...
              if (i.generatedLine === t.generatedLine) {
                ...
                null !== s &&
                  ...
                  null != this.sourceRoot && (s = a.join(this.sourceRoot, s)));
          ...
          (i.prototype.sourceContentFor = function(e, t) {
            ...
            if (
              (null != this.sourceRoot && (e = a.relative(this.sourceRoot, e)),
              this._sources.has(e))
            )
          ...
          ((o.prototype = Object.create(r.prototype)).constructor = r),
          ...
          (o.prototype.generatedPositionFor = function(e) {
            for (var t = 0; t < this._sections.length; t++) {
              ...
              if (-1 !== n.consumer.sources.indexOf(a.getArg(e, "source"))) {
          ...
          (r.prototype._serializeMappings = function() {
            for (
              ...
              if (((t = f[d]), (e = ""), t.generatedLine !== a))
                ...
                if (!s.compareByGeneratedPositionsInflated(t, f[d - 1]))
                  continue;
                e += ",";
              }
      ...
      function(e, t, n) {
        ...
        (r.fromStringWithSourceMap = function(e, t, n) {
          ...
          return (
            t.eachMapping(function(e) {
              if (null !== f) {
                if (!(p < e.generatedLine)) {
                  var t = (n = u[c]).substr(0, e.generatedColumn - h);
                  return (
                    (u[c] = n.substr(e.generatedColumn - h)),
                    (h = e.generatedColumn),
                    i(f, t),
                    void (f = e)
                  );
            ...
            c < u.length && (f && i(f, l()), a.add(u.splice(c).join(""))),
            t.sources.forEach(function(e) {
              var r = t.sourceContentFor(e);
              null != r &&
                (null != n && (e = s.join(n, e)), a.setSourceContent(e, r));
            }),
            a
          );
        }),
    ...
    25: [
      function(e, t, n) {
        t.exports = {
          ...
          _where:
            "/Users/evgenypoberezkin/Documents/JSON/ajv/node_modules/nodent",
          author: { name: "Mat At Bread", email: "nodent@mailed.me.uk" },
          ...
          main: "compiler.js",
          maintainers: [{ name: "matatbread", email: "npm@mailed.me.uk" }],
          name: "nodent-compiler",
              ...
              function i(t, n) {
                ...
                try {
                  if ((o = t.call(s, n)).done) {
                    if (o.value !== e) {
                      if (o.value && o.value === o.value.then)
                        return o.value(e, r);
                      e && e(o.value), (e = null);
                    }
                    return;
        ...
        var i = (function(e, t) {
          ...
          return (
            o.reverse().forEach(function(t) {
              r =
                r.slice(0, t.index) + e[t[1]] + r.substr(t.index + t[0].length);
            }),
            ...
            Function.prototype.$asyncbind ||
              ...
              e.trampoline ||
                (e.trampoline = function(e, t, n, r, i) {
                  return function s(o) {
                    for (; o; ) {
                      if (o.then) return (o = o.then(s, r)), i ? void 0 : o;
                      try {
                        if (o.pop) {
                          if (o.length) return o.pop() ? t.call(e) : o;
                          o = n;
                        } else o = o.call(e);
                      } catch (e) {
                        return r(e);
            ...
            var s = (function() {
              function e() {
                for (; n.length - r; ) {
                  ...
                  (n[r++] = void 0), r === i && (n.splice(0, i), (r = 0));
                }
              }
              var n = [],
                r = 0,
                ...
                resolve: function(e) {
                  if (void 0 === this.state) {
                    ...
                    (this.state = r),
                      ...
                      t.c &&
                        s(function() {
                          for (var n = 0, i = t.c.length; n < i; n++)
                            r(t.c[n], e);
                        });
                  }
                },
          ...
          t.exports = function(e, t, u) {
              ...
              t
                ...
                : h(w, function(t, n, r) {
                    if (t) d(t);
                      ...
                      var i = new Error(
                        "Cannot find module '" + e + "' from '" + x + "'"
                      );
                      (i.code = "MODULE_NOT_FOUND"), d(i);
                    }
                  });
            }
            function l(e, t, n) {
                ...
                function i(n, i, l) {
                  ...
                  if (l && c && y.pathFilter) {
                    var p = s.relative(l, u),
                      h = p.slice(0, p.length - e[0].length),
                      f = y.pathFilter(c, t, h);
                    if (f) return r([""].concat(b.slice()), s.resolve(l, f), c);
                  }
                  g(u, a);
                }
                function a(n, i) {
            ...
            function p(e, t) {
              ...
              if ("win32" === n.platform && /^\w:[/\\]*$/.test(e))
                return t(null);
              if (/[/\\]node_modules[/\\]*$/.test(e)) return t(null);
              ...
              g(r, function(n, i) {
                ...
                v(r, function(n, i) {
                  ...
                  s && y.packageFilter && (s = y.packageFilter(s, r)),
                    t(null, s, e);
                });
              });
            }
            function h(e, t, n) {
              var r = n,
                i = t;
              "function" == typeof i && ((r = i), (i = y.package));
              ...
              g(o, function(t, n) {
                return t
                  ...
                  ? void v(o, function(t, n) {
                      ...
                      if (
                        (y.packageFilter && (i = y.packageFilter(i, o)), i.main)
                      )
                        return (
                          ("." !== i.main && "./" !== i.main) ||
                            (i.main = "index"),
                          void l(s.resolve(e, i.main), i, function(t, n, i) {
                            if (t) return r(t);
                            if (n) return r(null, n, i);
                            if (!i) return l(s.join(e, "index"), i, r);
                            h(s.resolve(e, i.main), i, function(t, n, i) {
                              return t
                                ? r(t)
                                : n
                                ? r(null, n, i)
                                : void l(s.join(e, "index"), i, r);
                            });
                          })
                        );
            ...
            function f(t, n) {
              function r(e, r, i) {
                return e ? t(e) : r ? t(null, r, i) : void f(t, n.slice(1));
              }
      ...
      function(e, t, n) {
        (function(n) {
          function r(e) {
            if (!0 === e) return !0;
            for (
              var t = e.split(" "), n = t[0], r = t[1].split("."), s = 0;
              s < 3;
              ++s
            ) {
              var o = Number(i[s] || 0),
                a = Number(r[s] || 0);
              if (o !== a) return "<" === n ? o < a : ">=" === n && o >= a;
            }
            return !1;
          }
          var i =
              (n.versions && n.versions.node && n.versions.node.split(".")) ||
              [],
            s = e("./core.json"),
            o = {};
          for (var a in s)
            Object.prototype.hasOwnProperty.call(s, a) && (o[a] = r(s[a]));
          t.exports = o;
        }.call(this, e("_process")));
      },
    ...
    39: [
      function(e, t, n) {
        ...
        t.exports = function(e, t) {
          ...
          function u(e) {
            ...
            if (l(t))
              try {
                var r = p(t, "UTF8"),
                  i = JSON.parse(r);
                if ((c.packageFilter && (i = c.packageFilter(i, e)), i.main)) {
          ...
          if (r[e]) return e;
          var g = new Error("Cannot find module '" + e + "' from '" + f + "'");
        ...
        (function(process, global, __dirname) {
          ...
          function parseCompilerOptions(code, log, filename) {
            ...
            if ("string" == typeof code)
              ...
              for (
                var i = 0;
                i < code.body.length && isDirective(code.body[i].type);
                i++
              ) {
            ...
            if (set)
              try {
                ...
                var packagePath = require("resolve").sync("package.json", {
                  ...
                  packageOptions = JSON.parse(fs.readFileSync(packagePath))
            ...
            try {
              ...
              log(
                "Invalid literal compiler option: " +
                  ((regex && regex[0]) || "<no options found>")
              );
            }
            return (
              ...
              function(t, n, r) {
                if (Array.isArray(n)) {
                  ...
                  n =
                    n ||
                    function(e, t) {
                      return !(e.match(/Sync$/) && e.replace(/Sync$/, "") in t);
                    };
                r || (r = "");
          ...
          function generateRequestHandler(e, t, n) {
            var r = {},
              i = this;
            t || (t = /\.njs$/),
              n ? n.compiler || (n.compiler = {}) : (n = { compiler: {} });
            var s = copyObj([NodentCompiler.initialCodeGenOpts, n.compiler]);
            return function(o, a, u) {
              function c(e) {
                (a.statusCode = 500), a.write(e.toString()), a.end();
              }
              if (r[o.url])
                return (
                  a.setHeader("Content-Type", r[o.url].contentType),
              ...
              if (
                !(
                  o.url.match(t) ||
                  (n.htmlScriptRegex && o.url.match(n.htmlScriptRegex))
                )
              )
                return u && u();
              var l = e + o.url;
              if (n.extensions && !fs.existsSync(l))
                for (var p = 0; p < n.extensions.length; p++)
                  if (fs.existsSync(l + "." + n.extensions[p])) {
                    l = l + "." + n.extensions[p];
                    break;
                  }
                  ...
                  n.htmlScriptRegex && o.url.match(n.htmlScriptRegex)
                    ...
                    : (n.runtime
                        ? ((u =
                          ...
                          (u += "\n"))
                        : (u = ""),
                      (u += i.compile(t.toString(), o.url, null, s).code),
                      (l = "application/javascript")),
                    a.setHeader("Content-Type", l),
                    n.enableCache && (r[o.url] = { output: u, contentType: l }),
                    n.setHeaders && n.setHeaders(a),
                    a.write(u),
                    a.end();
                } catch (e) {
            ...
            return (
              this.covers[n] ||
                (e.indexOf("/") >= 0
                  ...
                  : (this.covers[n] = require(__dirname + "/covers/" + e))),
          ...
          function prepareMappedStackTrace(e, t) {
            return (
              ...
              t
                .map(function(e) {
                  var t = e.getFileName();
                  if (t && NodentCompiler.prototype.smCache[t]) {
          ...
          function setGlobalEnvironment(e) {
            ...
            try {
              ...
              e.log("Function prototypes already assigned: ", t.messsage);
            }
            defaultCodeGenOpts[defaultCodeGenOpts.$error] in global ||
              (global[
          ...
          function initialize(e) {
            function t(n, r) {
              if (!r.match(/nodent\/nodent\.js$/)) {
                ...
                for (var o = 0; o < i.length; o++)
                  if (r.slice(0, i[o].path.length) == i[o].path) {
                    if (i[o].jsCompiler) {
                      if (i[o].jsCompiler === t) break;
                      return i[o].jsCompiler.apply(this, arguments);
                    }
                    return stdJSLoader(n, r);
                  }
              ...
              var u = {
                path: r.replace(/\/node_modules\/nodent\/nodent\.js$/, "")
              };
              u.path &&
                ((u.version = JSON.parse(
                  fs.readFileSync(r.replace(/nodent\.js$/, "package.json"))
                ).version),
                stdJSLoader(n, r),
                (function(e, t) {
                  (e = e.split(".")), (t = t.split("."));
                  ...
                  return 0;
                })(u.version, NodentCompiler.prototype.version) < 0 &&
                  ((u.originalNodentLoader = n.exports),
                  (n.exports = function() {
                    var t = require.extensions[".js"],
                      n = u.originalNodentLoader.apply(this, arguments);
                    return (
                      (u.jsCompiler = require.extensions[".js"]),
                      (require.extensions[".js"] = t),
                      setGlobalEnvironment(e),
                      n
                    );
                  }),
                  Object.keys(u.originalNodentLoader).forEach(function(e) {
                    n.exports[e] = u.originalNodentLoader[e];
                  }),
                  i.push(u),
            ...
            function n(t) {
              ...
              require.extensions[t] = compileNodentedFile(compiler, e.log);
            }
            if (e) {
              for (var r in e)
                if ("use" !== r && !config.hasOwnProperty(r))
                  throw new Error(
                    "NoDent: unknown option: " + r + "=" + JSON.stringify(e[r])
                  );
            } else e = {};
            compiler
                ...
                (Array.isArray(e.use)
                  ...
                  : (e.log(
                    ...
                    Object.keys(e.use).forEach(function(t) {
                      compiler[t] = compiler.require(t, e.use[t]);
                    }))),
              compiler
            );
          }
          function runFromCLI() {
              ...
              try {
                ...
                if (r.fromast) {
                  ...
                  (o = parseCompilerOptions(
                    r.use ? '"use nodent-' + r.use + '";' : e,
                    i.log
                  )) ||
                    ((o = parseCompilerOptions('"use nodent";', i.log)),
                    r.dest ||
                      console.warn(
                        "/* " +
                          t +
                ...
                if (
                  ...
                  if (r.dest && !n)
                    throw new Error("Can't write unknown file to " + r.dest);
                  var u = "";
                  r.runtime &&
                    ((u +=
                      "Function.prototype.$asyncbind = " +
                ...
                (r.minast || r.parseast) &&
                  console.log(
                    JSON.stringify(
                      s.ast,
                      function(e, t) {
                        return "$" === e[0] || e.match(/^(start|end|loc)$/)
                          ? void 0
                          : t;
                      },
                      2,
            ...
            var t,
              ...
              (function(e) {
                for (var t = [], n = e || 2; n < process.argv.length; n++)
                  if ("--" === process.argv[n].slice(0, 2)) {
                    var r = process.argv[n].slice(2).split("=");
                    t[r[0]] = r[1] || !0;
            ...
            initialize.setDefaultCompileOptions({
              ...
              parser: r.noextensions ? { noNodentExtensions: !0 } : void 0
            });
            ...
            if (
              ...
              try {
                ...
                throw (e && (e.message = r[0] + ": " + e.message), e);
              }
            if (0 == r.length || "-" === r[0])
              return (
                (t = "(stdin)"),
          ...
          var stdJSLoader,
            ...
            optionSets = {
              ...
              promise: Object.create(defaultCodeGenOpts, {
                promises: { value: !0, writable: !0, enumerable: !0 }
              }),
              generator: Object.create(defaultCodeGenOpts, {
                generators: { value: !0, writable: !0, enumerable: !0 },
                es7: { value: !1, writable: !0, enumerable: !0 }
              }),
              engine: Object.create(defaultCodeGenOpts, {
                engine: { value: !0, writable: !0, enumerable: !0 },
                promises: { value: !0, writable: !0, enumerable: !0 }
              }),
              host: Object.create(defaultCodeGenOpts, {
                promises: { value: "host", writable: !0, enumerable: !0 },
                es6target: { value: "host", writable: !0, enumerable: !0 },
                engine: { value: "host", writable: !0, enumerable: !0 }
              })
            };
          ...
          (initialize.setDefaultCompileOptions = function(e, t) {
            return (
              e &&
                Object.keys(e).forEach(function(t) {
                  if (!(t in defaultCodeGenOpts))
                    throw new Error("NoDent: unknown compiler option: " + t);
              ...
              t &&
                Object.keys(t).forEach(function(e) {
                  if (!(e in t))
                    throw new Error(
                      "NoDent: unknown configuration option: " + e
                    );
                  config[e] = t[e];
                }),
              initialize
            ...
            (initialize.setCompileOptions = function(e, t) {
              return (
                (optionSet[e] = optionSet[e] || copyObj([defaultCodeGenOpts])),
                t &&
                  Object.keys(t).forEach(function(n) {
                    if (!(n in defaultCodeGenOpts))
                      throw new Error("NoDent: unknown compiler option: " + n);
                    optionSet[e][n] = t[n];
                  }),
                initialize
              );
            ...
            require.main === module && process.argv.length >= 3 && runFromCLI();
        }.call(
          this,
          require("_process"),
