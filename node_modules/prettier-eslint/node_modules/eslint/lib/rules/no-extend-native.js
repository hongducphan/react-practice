...
const propertyDefinitionMethods = new Set([
  "defineProperty",
  "defineProperties"
]);
    ...
    function isInPrototypePropertyAssignment(identifierNode) {
      return Boolean(
        isPrototypePropertyAccessed(identifierNode) &&
          ...
          identifierNode.parent.parent.parent.left ===
    ...
    function isInDefinePropertyCall(identifierNode) {
      return Boolean(
        isPrototypePropertyAccessed(identifierNode) &&
          ...
          propertyDefinitionMethods.has(
            identifierNode.parent.parent.callee.property.name
          )
      );
    }
