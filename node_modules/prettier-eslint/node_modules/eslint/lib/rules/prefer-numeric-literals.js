      ...
      CallExpression(node) {
        ...
        if (
          ...
          context.report({
            node,
            message:
              "Use {{radixName}} literals instead of {{functionName}}().",
            data: {
              radixName,
            ...
            fix(fixer) {
              ...
              if (
                +(newPrefix + node.arguments[0].value) !==
                parseInt(node.arguments[0].value, node.arguments[1].value)
              ) {
                /*
              ...
              return fixer.replaceText(
                node,
                prefixMap[node.arguments[1].value] + node.arguments[0].value
              );
            }
          });
        }
