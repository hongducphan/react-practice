      ...
      switch (node.type) {
        ...
        case "LogicalExpression": {
          ...
          const isRightShortCircuit =
            isRightConstant && isLogicalIdentity(node.right, node.operator);
        ...
        case "AssignmentExpression":
          return (
            node.operator === "=" && isConstant(node.right, inBooleanPosition)
          );
