 ...
 * @private
 */
QUOTE_SETTINGS.double.convert = QUOTE_SETTINGS.single.convert = QUOTE_SETTINGS.backtick.convert = function(
  str
) {
...
module.exports = {
  ...
  create(context) {
    ...
    function isJSXLiteral(node) {
      return (
        node.parent.type === "JSXAttribute" || node.parent.type === "JSXElement"
      );
    }
    ...
    function isPartOfDirectivePrologue(node) {
      ...
      if (
        block.type !== "Program" &&
        (block.type !== "BlockStatement" || !astUtils.isFunction(block.parent))
      ) {
        return false;
      }
        ...
        if (settings && typeof val === "string") {
          ...
          if (!isValid && avoidEscape) {
            isValid =
              ...
              rawVal.indexOf(settings.quote) >= 0;
          }
