...
module.exports = {
  ...
  create(context) {
    ...
    const isPathAndPatternsObject =
      ...
      (options[0].hasOwnProperty("paths") ||
        options[0].hasOwnProperty("patterns"));
    ...
    function reportPath(node) {
      ...
      const customMessage =
        restrictedPathMessages[importSource] &&
        restrictedPathMessages[importSource].message;
    ...
    function isRestrictedPath(importSource, importNames) {
      ...
      if (
        ...
        if (restrictedPathMessages[importSource].importNames) {
          isRestricted = isRestrictedObject(
            importNames,
            restrictedPathMessages[importSource].importNames
          );
        } else {
    ...
    function isRestrictedPattern(importSource) {
      return (
        restrictedPatterns.length > 0 &&
        restrictedPatternsMatcher.ignores(importSource)
      );
    }
