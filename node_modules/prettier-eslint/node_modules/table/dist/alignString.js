...
const alignCenter = (subject, width) => {
  ...
  if (halfWidth % 2 === 0) {
    return (
      _lodash2.default.repeat(" ", halfWidth) +
      subject +
      _lodash2.default.repeat(" ", halfWidth)
    );
  } else {
    ...
    return (
      _lodash2.default.repeat(" ", halfWidth) +
      subject +
      _lodash2.default.repeat(" ", halfWidth + 1)
    );
  }
};
...
exports.default = (subject, containerWidth, alignment) => {
  ...
  if (alignments.indexOf(alignment) === -1) {
    throw new Error(
      "Alignment parameter value must be a known alignment parameter value (left, right, center)."
    );
  }
