...
function getRelevantESLintConfig(eslintConfig, eslintPath) {
  ...
  var relevantRules = (0, _entries2.default)(rules).reduce(function(
    rulesAccumulator,
    _ref
  ) {
    ...
    if (loadedRules.has(name)) {
      ...
      if (!fixable) {
        logger.trace(
          "turing off rule:",
          (0, _stringify2.default)({ [name]: rule })
        );
        rule = ["off"];
      }
    }
...
function getPrettierOptionsFromESLintRules(
  ...
  if (ruleValueExists(prettierPluginOptions)) {
    prettierOptions = (0, _extends3.default)(
      {},
...
function configureOptions(
  ...
  if (optionIsGiven) {
    ...
    var option = ruleValueToPrettierOption(
      eslintRuleValue,
      fallbackPrettierOptions,
      rules
    );
...
function getValFromTrailingCommaConfig(objectConfig) {
  var _objectConfig$arrays = objectConfig.arrays,
    ...
    functions =
      _objectConfig$functio === undefined ? "" : _objectConfig$functio;
