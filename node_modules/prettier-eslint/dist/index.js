...
var _loglevelColoredLevelPrefix2 = _interopRequireDefault(
  _loglevelColoredLevelPrefix
);
...
var logger = (0, _loglevelColoredLevelPrefix2.default)({
...
function format(options) {
  var _options$logLevel = options.logLevel,
    logLevel =
      _options$logLevel === undefined
        ? getDefaultLogLevel()
        : _options$logLevel;

  logger.setLevel(logLevel);
  logger.trace(
    "called format with options:",
    (0, _prettyFormat2.default)(options)
  );

  var filePath = options.filePath,
    _options$text = options.text,
    text =
      _options$text === undefined
        ? getTextFromFilePath(filePath)
        : _options$text,
    _options$eslintPath = options.eslintPath,
    eslintPath =
      _options$eslintPath === undefined
        ? getModulePath(filePath, "eslint")
        : _options$eslintPath,
    _options$prettierPath = options.prettierPath,
    prettierPath =
      _options$prettierPath === undefined
        ? getModulePath(filePath, "prettier")
        : _options$prettierPath,
    prettierLast = options.prettierLast,
    fallbackPrettierOptions = options.fallbackPrettierOptions;

  var eslintConfig = (0, _lodash2.default)(
    {},
  ...
  if (typeof eslintConfig.globals === "object") {
    eslintConfig.globals = (0, _entries2.default)(eslintConfig.globals).map(
      function(_ref) {
  ...
  var prettierOptions = (0, _lodash2.default)(
    {},
  ...
  var formattingOptions = (0, _utils.getOptionsForFormatting)(
    eslintConfig,
    prettierOptions,
  ...
  var eslintExtensions = eslintConfig.extensions || [
    ".js",
    ".jsx",
    ".ts",
    ".tsx",
  ...
  var onlyPrettier = filePath
    ? !(eslintExtensions.indexOf(fileExtension) !== -1)
    : false;
  ...
  return function eslintFix(text, filePath) {
    ...
    try {
      ...
      logger.trace(
        ...
        (0, _prettyFormat2.default)(report)
      );
      ...
      var _report$results = (0, _slicedToArray3.default)(report.results, 1),
        ...
        output =
          _report$results$0$out === undefined ? text : _report$results$0$out;
...
function getESLintConfig(filePath, eslintPath) {
  ...
  try {
    ...
    logger.trace(
      ...
      (0, _prettyFormat2.default)(config)
    );
    return config;
  } catch (error) {
