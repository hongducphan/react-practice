      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          function(status) {
            ...
            var isActive =
              status === _utils.TransitionStatuses.ENTERED ||
              status === _utils.TransitionStatuses.EXITING;
            var directionClassName =
              (status === _utils.TransitionStatuses.ENTERING ||
                status === _utils.TransitionStatuses.EXITING) &&
            ...
            var orderClassName =
              ...
              (direction === "right"
                ? "carousel-item-next"
                : "carousel-item-prev");
            var itemClasses = (0, _utils.mapToCssModules)(
