...
function Alert(props) {
  ...
  var classes = (0, _utils.mapToCssModules)(
    (0, _classnames2.default)(className, "alert", "alert-" + color, {
      "alert-dismissible": toggle
    }),
    cssModule
  );

  var closeClasses = (0, _utils.mapToCssModules)(
    (0, _classnames2.default)("close", closeClassName),
    cssModule
  );

  var alertTransition = _extends({}, _Fade2.default.defaultProps, transition, {
