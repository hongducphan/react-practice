...
var Progress = function Progress(props) {
  ...
  var percent =
    ((0, _lodash2.default)(value) / (0, _lodash2.default)(max)) * 100;

  var progressClasses = (0, _utils.mapToCssModules)(
    (0, _classnames2.default)(className, "progress"),
    cssModule
  );

  var progressBarClasses = (0, _utils.mapToCssModules)(
