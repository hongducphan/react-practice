...
var propTypes = {
  ...
  addonType: _propTypes2.default.oneOfType([
    _propTypes2.default.bool,
    _propTypes2.default.oneOf(["prepend", "append"])
  ]),
  ...
  _createClass(Dropdown, [
    ...
    },
    {
      ...
      value: function handleDocumentClick(e) {
        if (
          e &&
          (e.which === 3 ||
            (e.type === "keyup" && e.which !== _utils.keyCodes.tab))
        )
          return;
    ...
    },
    {
      ...
      value: function handleKeyDown(e) {
        if (
          _utils.keyCodes.tab === e.which ||
          (/button/i.test(e.target.tagName) &&
            e.which === _utils.keyCodes.space) ||
        ...
        var menuClass = (0, _utils.mapToCssModules)(
          "dropdown-menu",
          this.props.cssModule
        );
        var itemClass = (0, _utils.mapToCssModules)(
          "dropdown-item",
          this.props.cssModule
        );
        var disabledClass = (0, _utils.mapToCssModules)(
          "disabled",
          this.props.cssModule
        );
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _omit = (0, _utils.omit)(this.props, [
            "toggle",
            "disabled",
            "inNavbar",
            "direction"
          ...
          attrs = _objectWithoutProperties(_omit, [
            "className",
            "cssModule",
            "dropup",
            "isOpen",
        ...
        var classes = (0, _utils.mapToCssModules)(
          (0, _classnames2.default)(
            ...
            ((_classNames = {}),
            _defineProperty(_classNames, "input-group-" + addonType, addonType),
            _defineProperty(_classNames, "btn-group", group),
            _defineProperty(_classNames, "btn-group-" + size, !!size),
            _defineProperty(_classNames, "dropdown", !group && !addonType),
            _defineProperty(_classNames, "show", isOpen),
            _defineProperty(_classNames, "nav-item", nav),
            _classNames)
          ),
          cssModule
        );
