...
var propTypes = {
  ...
  zIndex: _propTypes2.default.oneOfType([
    ...
    },
    {
      ...
      value: function init() {
        ...
        if (Modal.openCount === 0) {
          document.body.className = (0, _classnames2.default)(
            document.body.className,
            (0, _utils.mapToCssModules)("modal-open", this.props.cssModule)
          );
        }
        Modal.openCount += 1;
      }
    },
    {
      ...
      value: function destroy() {
        ...
        if (Modal.openCount <= 1) {
          var modalOpenClassName = (0, _utils.mapToCssModules)(
            "modal-open",
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _extends({}, modalAttributes, modalTransition, {
                  ...
                  cssModule: cssModule,
                  className: (0, _utils.mapToCssModules)(
                    (0, _classnames2.default)("modal", modalClassName),
                    cssModule
                  ),
                  innerRef: innerRef
                }),
