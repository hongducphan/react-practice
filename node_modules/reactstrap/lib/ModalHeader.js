...
var propTypes = {
  ...
  wrapTag: _propTypes2.default.oneOfType([
    _propTypes2.default.func,
    _propTypes2.default.string
  ]),
  ...
  charCode: _propTypes2.default.oneOfType([
    _propTypes2.default.string,
    _propTypes2.default.number
  ]),
  close: _propTypes2.default.object
};
...
var ModalHeader = function ModalHeader(props) {
  ...
  var classes = (0, _utils.mapToCssModules)(
    (0, _classnames2.default)(className, "modal-header"),
    cssModule
  );
